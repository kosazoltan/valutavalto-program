...
`);throw Error(`Database init failed:\n${a}`,{cause:e})}}function O(){if(!E)return;let e=E.export(),t=Buffer.from(e),n=D+`.tmp`;try{p.default.writeFileSync(n,t),p.default.renameSync(n,D)}catch{try{p.default.unlinkSync(n)}catch{}p.default.writeFileSync(D,t)}}function ge(e=31){let t=new Date;return t.setDate(t.getDate()+e),t.toISOString()}function k(e){return`${e}-${new Date().toISOString().replace(/\D/g,``).slice(0,14)}-${m.default.randomBytes(2).toString(`hex`).toUpperCase()}`}function A(e){return e==null?null:JSON.stringify(e)}function j(e){if(!E)throw Error(`Database not initialized`);E.run(`INSERT INTO local_audit_events (
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,[e,t,n,r,i,a,o,s,null,g,_,v,y,f,h,p]),O();let b=E.prepare(`SELECT last_insert_rowid() as id`);b.step();let ee=b.getAsObject();b.free();let x=ee.id??0;return j({entityType:`TRANSACTION`,eventType:e,referenceNumber:h,entityId:String(x),payload:{type:e,currencyCode:t,foreignAmount:n,hufAmount:r,roundedHufAmount:i,rate:a,handlingFee:o,discountPercent:s,denominations:f,idempotencyKey:p},customerSnapshot:{customerIdentifier:g,customerName:_,customerDocumentNumber:v,customerAddress:y},identificationSnapshot:{customerIdentifier:g,customerDocumentNumber:v},rateSnapshot:{currencyCode:t,rate:a,roundedHufAmount:i},status:`PENDING_UPLOAD`}),x}function be(){if(!E)return[];let e=[],t=E.prepare(`SELECT * FROM pending_transactions WHERE synced = 0 ORDER BY created_at ASC`);for(;t.step();){let n=t.getAsObject();e.push(n)}return t.free(),e}function xe(e,t,n,r,i,a,o,s,c,l,u,d,f){if(!E)throw Error(`Database not initialized`);let p=m.default.randomUUID(),h=k(`LC`);E.run(`INSERT INTO pending_conversions (
     ...
     ON CONFLICT(branch_code) DO UPDATE SET
       ...
       cached_at = excluded.cached_at`,[e,t,n,r,i,a,o,s]),O())}function We(){if(!E)return[];let e=[],t=E.prepare(`SELECT * FROM cached_branch_status ORDER BY branch_code ASC`);for(;t.step();)e.push(t.getAsObject());return t.free(),e}function Ge(){if(!E)return null;let e=E.prepare(`SELECT MAX(cached_at) as last_cached FROM cached_branch_status`);e.step();let t=e.getAsObject();return e.free(),t.last_cached??null}function Ke(){if(!E)return[];let e=[],t=E.prepare(`SELECT * FROM cached_rates ORDER BY currency_code ASC`);for(;t.step();)e.push(t.getAsObject());return t.free(),e}var L=`\x1B`,R=``,z={INIT:`${L}@`,ALIGN_CENTER:`${L}a\x01`,ALIGN_LEFT:`${L}a\x00`,BOLD_ON:`${L}E\x01`,BOLD_OFF:`${L}E\x00`,DOUBLE_WIDTH:`${R}!\x10`,DOUBLE_HEIGHT:`${R}!\x01`,DOUBLE_BOTH:`${R}!\x11`,NORMAL_SIZE:`${R}!\x00`,UNDERLINE_ON:`${L}-\x01`,UNDERLINE_OFF:`${L}-\x00`,CUT_PAPER:`${R}V\x00`,PARTIAL_CUT:`${R}V\x01`,FEED_LINES:e=>`${L}d${String.fromCharCode(e)}`,LINE:`─`.repeat(42),DOUBLE_LINE:`═`.repeat(42)},B={BEST_CHANGE:{name:`BEST CHANGE`,fullName:`EXCLUSIVE BEST CHANGE ZRT.`,taxNumber:`32313332-2-02`,address:`Szeged, Kárász u. 5.`},EXPRESSZ:{name:`EXPRESSZ`,fullName:`EXPRESSZ ÉKSZERHÁZ ÉS MINIBANK KFT.`,taxNumber:`14040535-2-02`,address:`Szeged, Klauzál tér 3.`}},qe={sell:`ELADÁSI BIZONYLAT`,buy:`VÁSÁRLÁSI BIZONYLAT`,transfer:`ÁTADÁS-ÁTVÉTELI BIZONYLAT`,storno:`STORNÓ BIZONYLAT`,conversion:`KONVERZIÓS BIZONYLAT`,closing:`NAPI ZÁRÁS`};function Je(e){let t=B[e.companyType]??B.BEST_CHANGE,n=[];if(n.push(z.INIT),n.push(z.ALIGN_CENTER),n.push(z.BOLD_ON),n.push(z.DOUBLE_BOTH),n.push(t.name),n.push(z.NORMAL_SIZE),n.push(t.fullName),n.push(z.BOLD_OFF),n.push(t.address),n.push(`Adószám: ${t.taxNumber}`),n.push(``),n.push(z.DOUBLE_LINE),n.push(``),n.push(z.BOLD_ON),n.push(z.DOUBLE_HEIGHT),n.push(qe[e.type]),n.push(z.NORMAL_SIZE),n.push(z.BOLD_OFF),n.push(``),n.push(z.ALIGN_LEFT),n.push(`Bizonylat: ${e.receiptNumber}`),n.push(`Dátum:     ${e.date}  ${e.time}`),n.push(`Pénztár:   ${e.branchCode}`),n.push(`Pénztáros: ${e.cashierName}`),n.push(``),n.push(z.LINE),e.type===`sell`||e.type===`buy`?n.push(...Ye(e)):e.type===`conversion`?n.push(...Ze(e)):e.type===`transfer`?n.push(...Xe(e)):e.type===`storno`?n.push(...Qe(e)):e.type===`closing`&&n.push(...$e(e)),e.customerName&&(n.push(``),n.push(z.LINE),n.push(z.BOLD_ON),n.push(`ÜGYFÉL ADATOK:`),n.push(z.BOLD_OFF),n.push(`Név:      ${e.customerName}`),e.customerDocType&&n.push(`Igazolv.: ${e.customerDocType}`),e.customerDocNumber&&n.push(`Szám:     ${e.customerDocNumber}`)),e.receiptNumber&&(e.type===`sell`||e.type===`buy`||e.type===`conversion`)){n.push(``),n.push(z.LINE),n.push(z.ALIGN_CENTER),n.push(``),n.push(z.BOLD_ON),n.push(`QR KÓD:`),n.push(z.BOLD_OFF);let r=[e.receiptNumber,e.date,(e.roundedHufAmount??e.hufAmount??0).toString(),e.currencyCode??`HUF`,t.taxNumber,e.branchCode].join(`|`);n.push(`[QR:${r}]`),n.push(``)}return n.push(``),n.push(z.DOUBLE_LINE),n.push(z.ALIGN_CENTER),n.push(`Köszönjük, hogy minket választott!`),n.push(``),n.push(z.FEED_LINES(4)),n.push(z.PARTIAL_CUT),n.join(`
`)}function Ye(e){let t=[],n=e.type===`sell`;return t.push(``),t.push(z.BOLD_ON),t.push(n?`Deviza eladás (HUF → valuta):`:`Deviza vásárlás (valuta → HUF):`),t.push(z.BOLD_OFF),t.push(``),t.push(`Valutanem:   ${e.currencyCode??`—`}`),t.push(`Összeg:      ${V(e.foreignAmount)} ${e.currencyCode??``}`),t.push(`Árfolyam:    ${H(e.rate)}`),t.push(``),t.push(z.LINE),t.push(z.BOLD_ON),t.push(`HUF összeg:  ${V(e.hufAmount)} Ft`),e.roundedHufAmount!==void 0&&e.roundingDiff!==void 0&&e.roundingDiff!==0?(t.push(`Kerekítés:   ${V(e.roundingDiff)} Ft`),t.push(z.DOUBLE_HEIGHT),t.push(`FIZETENDŐ:   ${V(e.roundedHufAmount)} Ft`),t.push(z.NORMAL_SIZE)):(t.push(z.DOUBLE_HEIGHT),t.push(`FIZETENDŐ:   ${V(e.roundedHufAmount??e.hufAmount)} Ft`),t.push(z.NORMAL_SIZE)),t.push(z.BOLD_OFF),t}function Xe(e){let t=[];return t.push(``),t.push(z.BOLD_ON),t.push(`Átadás-átvétel:`),t.push(z.BOLD_OFF),t.push(``),t.push(`Cél pénztár: ${e.transferTarget??`—`}`),t.push(`Valutanem:   ${e.currencyCode??`—`}`),t.push(`Összeg:      ${V(e.foreignAmount)} ${e.currencyCode??``}`),e.transferNote&&t.push(`Megjegyzés:  ${e.transferNote}`),t}function Ze(e){let t=[];return t.push(``),t.push(z.BOLD_ON),t.push(`Konverzió:`),t.push(z.BOLD_OFF),t.push(``),t.push(`Forrás:      ${V(e.sourceAmount)} ${e.sourceCurrencyCode??`—`}`),t.push(`Cél:         ${V(e.targetAmount)} ${e.targetCurrencyCode??`—`}`),t.push(`Köztes HUF:  ${V(e.hufAmount)} Ft`),t.push(`Árfolyam:    ${H(e.rate)}`),e.note&&t.push(`Megjegyzés:  ${e.note}`),t}function Qe(e){let t=[];return t.push(``),t.push(z.BOLD_ON),t.push(`STORNÓ:`),t.push(z.BOLD_OFF),t.push(``),t.push(`Eredeti biz.: ${e.originalReceiptNumber??`—`}`),t.push(`Valutanem:    ${e.currencyCode??`—`}`),t.push(`Összeg:       ${V(e.foreignAmount)} ${e.currencyCode??``}`),t.push(`HUF összeg:   ${V(e.hufAmount)} Ft`),e.stornoReason&&(t.push(``),t.push(`Indok: ${e.stornoReason}`)),t}function $e(e){let t=[],n=e.closingSummary;if(!n)return t.push(``),t.push(`(Nincs zárási adat)`),t;if(t.push(``),t.push(z.BOLD_ON),t.push(`FORGALMI ÖSSZESÍTŐ:`),t.push(z.BOLD_OFF),t.push(``),t.push(`Összes tranzakció: ${n.totalTransactions}`),t.push(`  - Eladás:        ${n.sellCount}`),t.push(`  - Vásárlás:      ${n.buyCount}`),t.push(``),t.push(`HUF forgalom:      ${V(n.totalHufTurnover)} Ft`),t.push(`Díjbevétel:        ${V(n.totalFees)} Ft`),t.push(``),t.push(z.LINE),t.push(`Nyitó egyenleg:    ${V(n.openingBalance)} Ft`),t.push(`Záró egyenleg:     ${V(n.closingBalance)} Ft`),n.discrepancies.length>0){t.push(``),t.push(z.BOLD_ON),t.push(`ELTÉRÉSEK:`),t.push(z.BOLD_OFF);for(let e of n.discrepancies)t.push(`  ${e.currencyCode}: várt ${V(e.expected)} → tény ${V(e.actual)} (${V(e.difference)})`)}return t}function V(e){return e===void 0?`—`:e.toLocaleString(`hu-HU`,{maximumFractionDigits:2})}function H(e){return e===void 0?`—`:e.toLocaleString(`hu-HU`,{minimumFractionDigits:2,maximumFractionDigits:4})}function et(e){let t=B[e.companyType]??B.BEST_CHANGE,n=qe[e.type],r=``;return r+=`
    <div class="center">
      <div class="company-name">${U(t.name)}</div>
      <div class="company-full">${U(t.fullName)}</div>
      <div>${U(t.address)}</div>
      <div>Adószám: ${U(t.taxNumber)}</div>
    </div>
    <div class="double-line"></div>
    <div class="center receipt-type">${U(n)}</div>
    <div class="meta">
      <div>Bizonylat: ${U(e.receiptNumber)}</div>
      <div>Dátum: ${U(e.date)} &nbsp; ${U(e.time)}</div>
      <div>Pénztár: ${U(e.branchCode)}</div>
      <div>Pénztáros: ${U(e.cashierName)}</div>
    </div>
    <div class="line"></div>
  `,e.type===`sell`||e.type===`buy`?r+=tt(e):e.type===`transfer`?r+=nt(e):e.type===`storno`?r+=rt(e):e.type===`closing`&&(r+=it(e)),e.customerName&&(r+=`
      <div class="line"></div>
      <div class="bold">ÜGYFÉL ADATOK:</div>
      <div>Név: ${U(e.customerName)}</div>
      ${e.customerDocType?`<div>Igazolv.: ${U(e.customerDocType)}</div>`:``}
      ${e.customerDocNumber?`<div>Szám: ${U(e.customerDocNumber)}</div>`:``}
    `),r+=`
    <div class="double-line"></div>
...
<body>${r}</body>
</html>`}function tt(e){let t=`
    <div class="section">
      <div class="bold">${U(e.type===`sell`?`Deviza eladás (HUF → valuta):`:`Deviza vásárlás (valuta → HUF):`)}</div>
      <div class="amount-row"><span>Valutanem:</span><span>${U(e.currencyCode??`—`)}</span></div>
      <div class="amount-row"><span>Összeg:</span><span>${V(e.foreignAmount)} ${U(e.currencyCode??``)}</span></div>
      <div class="amount-row"><span>Árfolyam:</span><span>${H(e.rate)}</span></div>
    </div>
    <div class="line"></div>
    <div class="amount-row bold"><span>HUF összeg:</span><span>${V(e.hufAmount)} Ft</span></div>
  `;return e.roundedHufAmount!==void 0&&e.roundingDiff!==void 0&&e.roundingDiff!==0?t+=`
      <div class="amount-row"><span>Kerekítés:</span><span>${V(e.roundingDiff)} Ft</span></div>
      <div class="amount-row total"><span>FIZETENDŐ:</span><span>${V(e.roundedHufAmount)} Ft</span></div>
    `:t+=`
      <div class="amount-row total"><span>FIZETENDŐ:</span><span>${V(e.roundedHufAmount??e.hufAmount)} Ft</span></div>
    `,t}function nt(e){return`
    <div class="section">
      <div class="bold">Átadás-átvétel:</div>
      <div class="amount-row"><span>Cél pénztár:</span><span>${U(e.transferTarget??`—`)}</span></div>
      <div class="amount-row"><span>Valutanem:</span><span>${U(e.currencyCode??`—`)}</span></div>
      <div class="amount-row"><span>Összeg:</span><span>${V(e.foreignAmount)} ${U(e.currencyCode??``)}</span></div>
      ${e.transferNote?`<div>Megjegyzés: ${U(e.transferNote)}</div>`:``}
    </div>
  `}function rt(e){return`
    <div class="section">
      <div class="bold">STORNÓ:</div>
      <div class="amount-row"><span>Eredeti biz.:</span><span>${U(e.originalReceiptNumber??`—`)}</span></div>
      <div class="amount-row"><span>Valutanem:</span><span>${U(e.currencyCode??`—`)}</span></div>
      <div class="amount-row"><span>Összeg:</span><span>${V(e.foreignAmount)} ${U(e.currencyCode??``)}</span></div>
      <div class="amount-row"><span>HUF összeg:</span><span>${V(e.hufAmount)} Ft</span></div>
      ${e.stornoReason?`<div>Indok: ${U(e.stornoReason)}</div>`:``}
    </div>
  `}function it(e){let t=e.closingSummary;if(!t)return`<div class="section">(Nincs zárási adat)</div>`;let n=``;return t.discrepancies.length>0&&(n=`
      <div class="bold discrepancy">ELTÉRÉSEK:</div>
      ${t.discrepancies.map(e=>`<div class="discrepancy">&nbsp;&nbsp;${U(e.currencyCode)}: várt ${V(e.expected)} → tény ${V(e.actual)} (${V(e.difference)})</div>`).join(``)}
    `),`
    <div class="section">
      ...
      <br/>
      <div class="amount-row"><span>HUF forgalom:</span><span>${V(t.totalHufTurnover)} Ft</span></div>
      <div class="amount-row"><span>Díjbevétel:</span><span>${V(t.totalFees)} Ft</span></div>
    </div>
    <div class="line"></div>
    <div class="amount-row"><span>Nyitó egyenleg:</span><span>${V(t.openingBalance)} Ft</span></div>
    <div class="amount-row"><span>Záró egyenleg:</span><span>${V(t.closingBalance)} Ft</span></div>
    ${n}
  `}function U(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}async function at(e){return!1}async function ot(e,t){let n=null;try{n=new l.BrowserWindow({show:!1,width:302,height:800,webPreferences:{contextIsolation:!0,nodeIntegration:!1}}),await n.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(e)}`);let r={silent:!0,printBackground:!0,margins:{marginType:`none`},pageSize:{width:8e4,height:297e3}};return t&&(r.deviceName=t),await new Promise(e=>{n.webContents.print(r,(t,n)=>{t||T.default.warn(`[PRINTER] Nyomtatás sikertelen: ${n}`),e(t)})})}catch(e){return T.default.error(`[PRINTER] printViaElectron hiba:`,e),!1}finally{n&&!n.isDestroyed()&&n.close()}}async function st(e,t){try{if(T.default.info(`[PRINTER] Nyomtatás indítása: ${e.type} ${e.receiptNumber}`),await at(Je(e)))return T.default.info(`[PRINTER] USB hőnyomtató: OK — ${e.receiptNumber}`),!0;T.default.info(`[PRINTER] USB nyomtató nem elérhető, Electron print fallback...`);let n=await ot(et(e),t);return n?T.default.info(`[PRINTER] Electron print: OK — ${e.receiptNumber}`):T.default.error(`[PRINTER] Nyomtatás sikertelen — ${e.receiptNumber}. Ellenőrizd a nyomtató állapotát (offline / papír kifogyott).`),n}catch(e){return T.default.error(`[PRINTER] Váratlan nyomtatási hiba:`,e),!1}}async function W(e,t){let n={"Content-Type":`application/json`};t&&(n.Authorization=`Bearer ${t}`);let r=await fetch(e,{method:`GET`,headers:n,signal:AbortSignal.timeout(1e4)});if(!r.ok)throw Error(`HTTP ${r.status}: ${r.statusText}`);return r.json()}async function G(e,t,n,r){let i={"Content-Type":`application/json`,"Idempotency-Key":r??crypto.randomUUID()};n&&(i.Authorization=`Bearer ${n}`);let a=await fetch(e,{method:`POST`,headers:i,body:JSON.stringify(t),signal:AbortSignal.timeout(15e3)});if(!a.ok)throw Error(`HTTP ${a.status}: ${a.statusText}`);return a.json()}var K=new class{intervalId=null;status={lastSyncAt:null,lastSyncResult:null,isRunning:!1};getServerUrl(){return M(`server_url`)??`http://localhost:8080/api/v1`}getAuthToken(){let e=M(`auth_token_encrypted`);if(e&&l.safeStorage.isEncryptionAvailable())try{return l.safeStorage.decryptString(Buffer.from(e,`base64`))}catch(e){console.warn(`[SyncEngine] Nem sikerült visszafejteni a tárolt auth tokent:`,e)}return M(`auth_token`)}start(e=3e4){this.intervalId&&(console.log(`[SyncEngine] Már fut, újraindítás...`),this.stop()),console.log(`[SyncEngine] Indítás — ${e}ms intervallum`),setTimeout(()=>{this.runSync()},5e3),this.intervalId=setInterval(()=>{this.runSync()},e)}stop(){this.intervalId&&(clearInterval(this.intervalId),this.intervalId=null,console.log(`[SyncEngine] Leállítva`))}async runSync(){if(this.status.isRunning){console.log(`[SyncEngine] Előző sync még fut, kihagyás`);return}this.status.isRunning=!0;try{let e=await this.syncAll();this.status.lastSyncResult=e,e.synced>0&&console.log(`[SyncEngine] ${e.synced} tranzakció szinkronizálva`),e.failed>0&&console.warn(`[SyncEngine] ${e.failed} tranzakció SIKERTELEN:`,e.errors),this.getAuthToken()&&(await this.syncRates(),await this.syncCirculars(),await this.syncDistributions(),await this.syncTransfers(),await this.syncCollections(),await this.cacheBranchStatus()),this.status.lastSyncAt=new Date().toISOString()}catch(e){console.error(`[SyncEngine] Sync hiba:`,e)}finally{this.status.isRunning=!1}}async syncAll(){let e={synced:0,failed:0,errors:[]},t=be(),n=Se(),r=I(),i=Oe(),a=F(),o=Ve(),s=Ie(),c=ze(),l=t.length+n.length+r.length+i.length+a.length+o.length+s.length+c.length;if(l===0)return e;let u=this.getServerUrl(),d=this.getAuthToken();if(!d)return e.errors.push(`Nincs auth token — bejelentkezés szükséges`),e.failed=l,e;for(let n of t)try{await this.syncTransaction(u,d,n),we(n.id),e.synced++}catch(t){let r=t instanceof Error?t.message:String(t);if(e.failed++,e.errors.push(`TX #${n.id} (${n.type} ${n.currency_code}): ${r}`),r.includes(`fetch`)||r.includes(`network`)||r.includes(`timeout`)){e.errors.push(`Hálózati hiba — további próbálkozások leállítva`),e.failed+=l-e.synced-e.failed;break}}if(e.errors.some(e=>e.includes(`Hálózati hiba`)))return e;for(let t of n)try{await this.syncConversion(u,d,t),Ce(t.id),e.synced++}catch(n){let r=n instanceof Error?n.message:String(n);if(e.failed++,e.errors.push(`CONV #${t.id} (${t.from_currency_code}->${t.to_currency_code}): ${r}`),r.includes(`fetch`)||r.includes(`network`)||r.includes(`timeout`)){e.errors.push(`Hálózati hiba — további próbálkozások leállítva`),e.failed+=l-e.synced-e.failed;break}}if(e.errors.some(e=>e.includes(`Hálózati hiba`)))return e;for(let t of r)try{await this.syncBankTransaction(u,d,t),Pe(t.id),e.synced++}catch(n){let r=n instanceof Error?n.message:String(n);if(e.failed++,e.errors.push(`BANK #${t.id} (${t.transaction_type} ${t.currency_code}): ${r}`),r.includes(`fetch`)||r.includes(`network`)||r.includes(`timeout`)){e.errors.push(`Hálózati hiba — további próbálkozások leállítva`),e.failed+=l-e.synced-e.failed;break}}if(e.errors.some(e=>e.includes(`Hálózati hiba`)))return e;for(let t of i)try{await this.syncDistribution(u,d,t),ke(t.id),e.synced++}catch(n){let r=n instanceof Error?n.message:String(n);if(e.failed++,e.errors.push(`DIST #${t.id} (${t.currency_code}): ${r}`),r.includes(`fetch`)||r.includes(`network`)||r.includes(`timeout`)){e.errors.push(`Hálózati hiba — további próbálkozások leállítva`),e.failed+=l-e.synced-e.failed;break}}if(e.errors.some(e=>e.includes(`Hálózati hiba`)))return e;for(let t of a)try{await this.syncTransfer(u,d,t),je(t.id),e.synced++}catch(n){let r=n instanceof Error?n.message:String(n);if(e.failed++,e.errors.push(`TRANSFER #${t.id} (${t.currency_code}): ${r}`),r.includes(`fetch`)||r.includes(`network`)||r.includes(`timeout`)){e.errors.push(`Hálózati hiba — további próbálkozások leállítva`),e.failed+=l-e.synced-e.failed;break}}if(e.errors.some(e=>e.includes(`Hálózati hiba`)))return e;for(let t of o)try{await this.syncCollection(u,d,t),He(t.id),e.synced++}catch(n){let r=n instanceof Error?n.message:String(n);if(e.failed++,e.errors.push(`COLLECTION #${t.id} (${t.currency_code}): ${r}`),r.includes(`fetch`)||r.includes(`network`)||r.includes(`timeout`)){e.errors.push(`Hálózati hiba — további próbálkozások leállítva`),e.failed+=l-e.synced-e.failed;break}}if(e.errors.some(e=>e.includes(`Hálózati hiba`)))return e;for(let t of s)try{await this.syncStorno(u,d,t),Le(t.id),e.synced++}catch(n){let r=n instanceof Error?n.message:String(n);if(e.failed++,e.errors.push(`STORNO #${t.id} (${t.original_receipt_number}): ${r}`),r.includes(`fetch`)||r.includes(`network`)||r.includes(`timeout`)){e.errors.push(`Hálózati hiba — további próbálkozások leállítva`),e.failed+=l-e.synced-e.failed;break}}if(e.errors.some(e=>e.includes(`Hálózati hiba`)))return e;for(let t of c)try{await this.syncHandoverOperation(u,d,t),Be(t.id),e.synced++}catch(n){let r=n instanceof Error?n.message:String(n);if(e.failed++,e.errors.push(`HANDOVER #${t.id} (${t.operation_type}): ${r}`),r.includes(`fetch`)||r.includes(`network`)||r.includes(`timeout`)){e.errors.push(`Hálózati hiba — további próbálkozások leállítva`),e.failed+=l-e.synced-e.failed;break}}return e}async syncTransaction(e,t,n){let r=n.type===`SELL`?`${e}/transactions/sell`:`${e}/transactions/buy`,i={currencyCode:n.currency_code,currencyAmount:n.foreign_amount,customExchangeRate:n.rate};n.handling_fee!==null&&n.handling_fee!==void 0&&(i.handlingFee=n.handling_fee),n.discount_percent!==null&&n.discount_percent!==void 0&&(i.discountPercent=n.discount_percent);let a=n.customer_identifier??(typeof n.customer_id==`string`?n.customer_id:null);if(a&&a.trim().length>0&&(i.customerId=a),n.customer_name&&n.customer_name.trim().length>0&&(i.customerName=n.customer_name),n.customer_document_number&&n.customer_document_number.trim().length>0&&(i.customerDocumentNumber=n.customer_document_number),n.customer_address&&n.customer_address.trim().length>0&&(i.customerAddress=n.customer_address),n.denominations!==null)try{i.denominations=JSON.parse(n.denominations)}catch{i.denominations=n.denominations}await G(r,i,t,n.idempotency_key??void 0)}async syncConversion(e,t,n){let r={fromAmount:n.from_amount};n.from_currency_id&&n.from_currency_id>0?r.fromCurrencyId=n.from_currency_id:r.fromCurrencyCode=n.from_currency_code,n.to_currency_id&&n.to_currency_id>0?r.toCurrencyId=n.to_currency_id:r.toCurrencyCode=n.to_currency_code,n.handling_fee!==null&&n.handling_fee!==void 0&&(r.handlingFee=n.handling_fee),n.customer_id&&n.customer_id.trim().length>0&&(r.customerId=n.customer_id),n.customer_name&&n.customer_name.trim().length>0&&(r.customerName=n.customer_name),n.customer_document_number&&n.customer_document_number.trim().length>0&&(r.customerDocumentNumber=n.customer_document_number),await G(`${e}/transactions/conversion`,r,t,n.idempotency_key??void 0)}async syncBankTransaction(e,t,n){let r={transactionType:n.transaction_type,currencyCode:n.currency_code,amount:n.amount,exchangeRate:n.exchange_rate};n.vault_territory_id!==null&&n.vault_territory_id!==void 0&&(r.vaultTerritoryId=n.vault_territory_id),n.bank_name&&n.bank_name.trim().length>0&&(r.bankName=n.bank_name),n.bank_reference&&n.bank_reference.trim().length>0&&(r.bankReference=n.bank_reference),n.note&&n.note.trim().length>0&&(r.note=n.note),await G(`${e}/ertektar/bank-transactions`,r,t,n.idempotency_key??void 0)}async syncStorno(e,t,n){let r={transactionId:n.transaction_id,reason:n.reason};n.approval_id&&(r.approvalId=n.approval_id),n.custom_exchange_rate!==null&&n.custom_exchange_rate!==void 0&&(r.customExchangeRate=n.custom_exchange_rate),n.payment_method&&(r.paymentMethodDid=n.payment_method),await G(`${e}/stornos/execute`,r,t,n.idempotency_key??void 0)}async syncDistribution(e,t,n){let r={targetBranchCode:n.target_branch_code,currencyCode:n.currency_code,amount:n.amount};if(n.denominations)try{r.denominations=JSON.parse(n.denominations)}catch{}n.note&&(r.note=n.note),await G(`${e}/ertektar/distribution`,r,t,n.idempotency_key??void 0)}async syncTransfer(e,t,n){let r={amount:n.amount,targetBranchCode:n.target_branch_code,currencyCode:n.currency_code};if(n.target_branch_id&&(r.toBranchId=n.target_branch_id),n.currency_id!==null&&n.currency_id!==void 0&&(r.currencyId=n.currency_id),n.transfer_type&&(r.transferType=n.transfer_type),n.huf_value!==null&&n.huf_value!==void 0&&(r.hufValue=n.huf_value),n.denominations)try{r.denominations=JSON.parse(n.denominations)}catch{}n.note&&(r.notes=n.note),await G(`${e}/transfers`,r,t,n.idempotency_key??void 0)}async syncCollection(e,t,n){let r={sourceBranchCode:n.source_branch_code,currencyCode:n.currency_code,amount:n.amount};n.note&&(r.note=n.note),await G(`${e}/ertektar/collections`,r,t,n.idempotency_key??void 0)}async syncHandoverOperation(e,t,n){if(n.operation_type===`GENERATE`){await G(`${e}/handover-sheets/generate`,{fromCashDeskId:n.from_cash_desk_id,toCashDeskId:n.to_cash_desk_id,transferDate:n.transfer_date,amounts:n.amounts_json?JSON.parse(n.amounts_json):{}},t,n.idempotency_key??void 0);return}if(!n.sheet_id)throw Error(`Hiányzó handover sheet id`);await G(n.operation_type===`PRINT`?`${e}/handover-sheets/${n.sheet_id}/print`:`${e}/handover-sheets/${n.sheet_id}/complete`,{},t,n.idempotency_key??void 0)}async syncRates(){try{let e=this.getServerUrl(),t=this.getAuthToken(),n=await W(`${e}/exchange-rates/pos-current`,t),r=Ee();if(!r||!Array.isArray(n))return;for(let e of n)r.run(`INSERT INTO cached_rates (currency_code, buy_rate, sell_rate, unit, updated_at,
      ...
      `);for(let e of n)r.run(`INSERT INTO cached_circulars (id, subject, body, sender, sent_at)
           ...
           ON CONFLICT(id) DO UPDATE SET
             ...
             sent_at = excluded.sent_at`,[e.id,e.subject,e.body,e.sender,e.sentAt]);n.length>0&&(O(),console.log(`[SyncEngine] ${n.length} körlevél szinkronizálva`))}catch(e){console.warn(`[SyncEngine] Körlevél sync hiba:`,e instanceof Error?e.message:e)}}async syncDistributions(){try{let e=Oe();if(e.length===0)return;let t=this.getServerUrl(),n=this.getAuthToken();if(!n)return;for(let r of e)try{let e={targetBranchCode:r.target_branch_code,currencyCode:r.currency_code,amount:r.amount};if(r.denominations)try{e.denominations=JSON.parse(r.denominations)}catch{}r.note&&(e.note=r.note),await G(`${t}/ertektar/distribution`,e,n,r.idempotency_key??void 0),ke(r.id)}catch(e){console.warn(`[SyncEngine] Distribution #${r.id} sync hiba:`,e instanceof Error?e.message:e);break}}catch(e){console.warn(`[SyncEngine] Distribution sync hiba:`,e instanceof Error?e.message:e)}}async syncTransfers(){try{let e=F();if(e.length===0)return;let t=this.getServerUrl(),n=this.getAuthToken();if(!n)return;for(let r of e)try{let e={amount:r.amount};if(r.target_branch_id&&(e.toBranchId=r.target_branch_id),e.targetBranchCode=r.target_branch_code,r.currency_id!==null&&r.currency_id!==void 0&&(e.currencyId=r.currency_id),e.currencyCode=r.currency_code,r.transfer_type&&(e.transferType=r.transfer_type),r.huf_value!==null&&r.huf_value!==void 0&&(e.hufValue=r.huf_value),r.denominations)try{e.denominations=JSON.parse(r.denominations)}catch{}r.note&&(e.notes=r.note),await G(`${t}/transfers`,e,n,r.idempotency_key??void 0),je(r.id)}catch(e){console.warn(`[SyncEngine] Transfer #${r.id} sync hiba:`,e instanceof Error?e.message:e);break}}catch(e){console.warn(`[SyncEngine] Transfer sync hiba:`,e instanceof Error?e.message:e)}}async syncCollections(){try{let e=Ve();if(e.length===0)return;let t=this.getServerUrl(),n=this.getAuthToken();if(!n)return;for(let r of e)try{let e={sourceBranchCode:r.source_branch_code,currencyCode:r.currency_code,amount:r.amount};r.note&&(e.note=r.note),await G(`${t}/ertektar/collections`,e,n,r.idempotency_key??void 0),He(r.id)}catch(e){console.warn(`[SyncEngine] Collection #${r.id} sync hiba:`,e instanceof Error?e.message:e);break}}catch(e){console.warn(`[SyncEngine] Collection sync hiba:`,e instanceof Error?e.message:e)}}async cacheBranchStatus(){try{let e=this.getServerUrl(),t=this.getAuthToken(),n=await W(`${e}/ertektar/branches/status`,t);if(!Array.isArray(n))return;for(let e of n)Ue(e.code,e.name,e.companyId,e.lastSyncAt,e.onlineStatus,e.totalHufValue,e.dailyTurnover,e.cashBalances?JSON.stringify(e.cashBalances):null);n.length>0&&console.log(`[SyncEngine] ${n.length} pénztár státusz cache-elve`)}catch(e){console.warn(`[SyncEngine] Branch status cache hiba:`,e instanceof Error?e.message:e)}}getStatus(){return{...this.status}}},q=`C:/valuta/camera`;function ct(e){let t=e.replace(/[^a-zA-Z0-9_-]/g,``);if(!t||t!==e)throw Error(`Invalid transactionId: `+e);return t}function J(e){return p.default.existsSync(e)?p.default.readdirSync(e).filter(t=>{let n=u.default.join(e,t);return p.default.existsSync(n)&&p.default.statSync(n).isDirectory()}):[]}function Y(e){if(!p.default.existsSync(e))return[];let t=[],n=p.default.readdirSync(e,{withFileTypes:!0});for(let r of n){let n=u.default.join(e,r.name);r.isDirectory()?t.push(...Y(n)):r.isFile()&&t.push(n)}return t}function lt(e,t){if(!p.default.existsSync(e))return 0;p.default.mkdirSync(t,{recursive:!0});let n=0,r=p.default.readdirSync(e,{withFileTypes:!0});for(let i of r){let r=u.default.join(e,i.name),a=u.default.join(t,i.name);i.isDirectory()?n+=lt(r,a):i.isFile()&&(p.default.mkdirSync(u.default.dirname(a),{recursive:!0}),p.default.copyFileSync(r,a),n+=1)}return n}l.ipcMain.handle(`camera-save-recording`,async(e,t,n,r)=>{let i=new Date().toISOString().slice(0,10),a=ct(t),o=u.default.join(q,i,a);p.default.mkdirSync(o,{recursive:!0});let s=`recording_${Date.now()}.${r}`,c=u.default.join(o,s);return p.default.writeFileSync(c,Buffer.from(n)),c}),l.ipcMain.handle(`camera-export-to-usb`,async(e,t,n)=>{let r=await l.dialog.showOpenDialog({title:`Válaszd ki az USB meghajtót`,properties:[`openDirectory`],buttonLabel:`Exportálás ide`});if(r.canceled||!r.filePaths[0])return{success:!1,exported:0,error:`Megszakítva`};let i=new Date(t),a=new Date(n);if(Number.isNaN(i.getTime())||Number.isNaN(a.getTime()))return{success:!1,exported:0,error:`Érvénytelen dátum`};if(i>a)return{success:!1,exported:0,error:`A dátumtartomány hibás`};try{let e=u.default.join(r.filePaths[0],`valuta_kamera_export`);p.default.mkdirSync(e,{recursive:!0});let t=0,n=J(q);for(let r of n){let n=new Date(r);if(Number.isNaN(n.getTime())||n<i||n>a)continue;let o=u.default.join(q,r),s=u.default.join(e,r);t+=lt(o,s)}return{success:!0,exported:t}}catch(e){return{success:!1,exported:0,error:`Írási hiba: ${e.message}`}}}),l.ipcMain.handle(`camera-list-recordings`,async(e,t)=>{if(!p.default.existsSync(q))return[];if(t){let e=[],n=ct(t),r=J(q);for(let t of r){let r=u.default.join(q,t,n);e.push(...Y(r))}return e}return Y(q)});function ut(e){if(!p.default.existsSync(e))return 0;let t=0,n=p.default.readdirSync(e,{withFileTypes:!0});for(let r of n){let n=u.default.join(e,r.name);if(r.isDirectory())t+=ut(n);else if(r.isFile())try{t+=p.default.statSync(n).size}catch{}}return t}l.ipcMain.handle(`camera-local-storage-stats`,async()=>{if(!p.default.existsSync(q))return{totalUsageBytes:0,availableSpaceBytes:0,totalRecordings:0,oldestDate:null,newestDate:null};let e=ut(q),t=Y(q),n=J(q).sort(),r=0;try{let e=p.default.statfsSync(q);r=Number(e.bavail)*Number(e.bsize)}catch{}return{totalUsageBytes:e,availableSpaceBytes:r,totalRecordings:t.length,oldestDate:n.length>0?n[0]:null,newestDate:n.length>0?n[n.length-1]:null}}),l.ipcMain.handle(`camera-local-recordings-by-date`,async(e,t,n)=>{if(!p.default.existsSync(q))return[];let r=new Date(t),i=new Date(n);if(Number.isNaN(r.getTime())||Number.isNaN(i.getTime()))return[];let a=[],o=J(q);for(let e of o){let t=new Date(e);if(Number.isNaN(t.getTime())||t<r||t>i)continue;let n=J(u.default.join(q,e));for(let t of n){let n=Y(u.default.join(q,e,t));for(let r of n)try{let n=p.default.statSync(r);a.push({date:e,transactionId:t,filePath:r,fileSizeBytes:n.size,createdAt:n.birthtime.toISOString()})}catch{}}}return a}),l.ipcMain.handle(`camera-local-read-file`,async(e,t)=>{let n=u.default.resolve(t);return!n.startsWith(u.default.resolve(q))||!p.default.existsSync(n)?null:p.default.readFileSync(n).toString(`base64`)}),l.ipcMain.handle(`camera-local-cleanup`,async(e,t)=>{if(!p.default.existsSync(q))return{deletedCount:0};let n=new Date;n.setDate(n.getDate()-t);let r=0;for(let e of J(q)){let t=new Date(e);if(Number.isNaN(t.getTime())||t>=n)continue;let i=u.default.join(q,e),a=Y(i).length;try{p.default.rmSync(i,{recursive:!0,force:!0}),r+=a}catch{}}return{deletedCount:r}});var X=`C:/valuta/scan`,Z=`C:/valuta/.scan_key`;function dt(e){let t=e.replace(/[^a-zA-Z0-9_-]/g,``);if(!t||t!==e)throw Error(`Invalid transactionId: `+e);return t}function ft(){if(p.default.existsSync(Z)){let e=p.default.readFileSync(Z,`utf8`).trim();return Buffer.from(e,`base64`)}let e=m.default.randomBytes(32);return p.default.writeFileSync(Z,e.toString(`base64`),{mode:384}),e}function pt(e){let t=ft(),n=m.default.randomBytes(16),r=m.default.createCipheriv(`aes-256-gcm`,t,n),i=Buffer.concat([r.update(e),r.final()]),a=r.getAuthTag();return{encrypted:i,iv:n.toString(`hex`),tag:a.toString(`hex`)}}function mt(e,t,n){let r=ft(),i=m.default.createDecipheriv(`aes-256-gcm`,r,Buffer.from(t,`hex`));return i.setAuthTag(Buffer.from(n,`hex`)),Buffer.concat([i.update(e),i.final()])}l.ipcMain.handle(`scan-save-document`,async(e,t,n,r)=>{let{encrypted:i,iv:a,tag:o}=pt(Buffer.from(r,`base64`)),s=new Date().toISOString().slice(0,10),c=dt(t),l=u.default.join(X,s,c);p.default.mkdirSync(l,{recursive:!0});let d=`${n}_${Date.now()}.enc`,f=u.default.join(l,d);return p.default.writeFileSync(f,i),p.default.writeFileSync(`${f}.meta`,JSON.stringify({iv:a,tag:o,documentType:n,timestamp:new Date().toISOString()})),{path:f,encrypted:!0}}),l.ipcMain.handle(`scan-get-document`,async(e,t)=>{let n=u.default.resolve(t);if(!n.startsWith(u.default.resolve(X)))throw Error(`Érvénytelen fájlútvonal`);let r=p.default.readFileSync(n),i=p.default.readFileSync(`${n}.meta`,`utf8`),a=JSON.parse(i);return mt(r,a.iv,a.tag).toString(`base64`)}),l.ipcMain.handle(`scan-list-documents`,async(e,t)=>{if(!p.default.existsSync(X))return[];let n=[],r=dt(t),i=p.default.readdirSync(X);for(let e of i){let t=u.default.join(X,e,r);if(!p.default.existsSync(t)||!p.default.statSync(t).isDirectory())continue;let i=p.default.readdirSync(t);for(let e of i)e.endsWith(`.enc`)&&n.push(u.default.join(t,e))}return n}),l.ipcMain.handle(`restart-app`,()=>{try{return l.app.relaunch(),l.app.exit(0),!0}catch(e){return T.default.error(`[Updater] restart-app failed`,e),!1}});var Q=!l.app.isPackaged;l.protocol.registerSchemesAsPrivileged([{scheme:`app`,privileges:{standard:!0,secure:!0,supportFetchAPI:!0,corsEnabled:!0,stream:!0}}]),T.default.initialize(),T.default.transports.file.level=`info`,T.default.transports.console.level=Q?`debug`:`warn`,process.on(`uncaughtException`,e=>{T.default.error(`[Process] uncaughtException`,e)}),process.on(`unhandledRejection`,e=>{T.default.error(`[Process] unhandledRejection`,e)});var $=null;function ht(){$=new l.BrowserWindow({width:1280,height:1024,resizable:Q,fullscreen:!1,autoHideMenuBar:!0,title:`Valuta Pénztár`,webPreferences:{preload:u.default.join(__dirname,`preload.js`),contextIsolation:!0,nodeIntegration:!1,sandbox:!0,webSecurity:!0,allowRunningInsecureContent:!1,experimentalFeatures:!1}}),Q?($.loadURL(`http://localhost:3000`),$.webContents.openDevTools({mode:`detach`})):$.loadURL(`app://localhost/index.html`),$.webContents.on(`console-message`,(e,t,n,r,i)=>{t>=2&&T.default.warn(`[Renderer] L${t} ${i}:${r} — ${n}`)}),$.webContents.on(`render-process-gone`,(e,t)=>{T.default.error(`[Renderer] Process gone:`,t.reason),l.dialog.showErrorBox(`Megjelenítési hiba`,`A program megjelenítő folyamata leállt.\nOk: ${t.reason}\n\nKérjük, indítsa újra az alkalmazást.`)}),$.webContents.on(`before-input-event`,(e,t)=>{t.key===`F12`&&t.type===`keyDown`&&$?.webContents.toggleDevTools()}),$.webContents.on(`will-navigate`,(e,t)=>{[`app://localhost`,`http://localhost:3000`].some(e=>t.startsWith(e))||(T.default.warn(`[Security] Blocked navigation to: ${t}`),e.preventDefault())}),$.webContents.setWindowOpenHandler(({url:e})=>(T.default.warn(`[Security] Blocked popup window: ${e}`),{action:`deny`})),$.on(`closed`,()=>{$=null})}l.ipcMain.handle(`print-receipt`,async(e,t)=>{try{return await st(JSON.parse(t))}catch(e){return console.error(`[IPC] print-receipt hiba:`,e),!1}}),l.ipcMain.handle(`get-config`,async(e,t)=>M(t)),l.ipcMain.handle(`set-config`,async(e,t,n)=>{N(t,n)}),l.ipcMain.handle(`delete-config`,async(e,t)=>{P(t)}),l.ipcMain.handle(`save-pending-transaction`,async(e,t,n,r,i,a,o,s,c,l,u,d,f,p)=>ye(t,n,r,i,a,o,s,c,l,u,d,f,p)),l.ipcMain.handle(`get-pending-transactions`,async()=>be()),l.ipcMain.handle(`save-pending-conversion`,async(e,t,n,r,i,a,o,s,c,l,u,d,f,p)=>xe(t,n,r,i,a,o,s,c,l,u,d,f,p)),l.ipcMain.handle(`get-pending-conversions`,async()=>Se()),l.ipcMain.handle(`save-pending-bank-transaction`,async(e,t,n,r,i,a,o,s,c,l)=>Ne(t,n,r,i,a,o,s,c,l)),l.ipcMain.handle(`get-pending-bank-transactions`,async()=>I()),l.ipcMain.handle(`save-pending-storno`,async(e,t)=>Fe(t)),l.ipcMain.handle(`get-pending-stornos`,async()=>Ie()),l.ipcMain.handle(`get-pending-transaction-count`,async()=>Te()),l.ipcMain.handle(`mark-transaction-synced`,async(e,t)=>{we(t)}),l.ipcMain.handle(`mark-conversion-synced`,async(e,t)=>{Ce(t)}),l.ipcMain.handle(`mark-bank-transaction-synced`,async(e,t)=>{Pe(t)}),l.ipcMain.handle(`mark-storno-synced`,async(e,t)=>{Le(t)}),l.ipcMain.handle(`sync-offline`,async()=>(await K.syncAll()).synced),l.ipcMain.handle(`get-sync-status`,async()=>JSON.stringify(K.getStatus())),l.ipcMain.handle(`get-app-version`,async()=>l.app.getVersion()),l.ipcMain.handle(`get-printers`,async()=>$?$.webContents.getPrintersAsync():[]),l.ipcMain.handle(`save-pending-distribution`,async(e,t,n,r,i,a)=>De(t,n,r,i,a)),l.ipcMain.handle(`save-pending-transfer`,async(e,t,n,r,i,a,o,s,c,l)=>Ae(t,n,r,i,a,o,s,c,l)),l.ipcMain.handle(`get-pending-transfers`,async()=>F()),l.ipcMain.handle(`save-pending-collection`,async(e,t,n,r,i)=>Me(t,n,r,i)),l.ipcMain.handle(`save-pending-handover-operation`,async(e,t)=>Re(t)),l.ipcMain.handle(`get-pending-handover-operations`,async()=>ze()),l.ipcMain.handle(`get-cached-branch-statuses`,async()=>We()),l.ipcMain.handle(`get-cached-branch-status-timestamp`,async()=>Ge()),l.ipcMain.handle(`get-cached-rates`,async()=>Ke()),l.ipcMain.handle(`save-local-audit-event`,async(e,t)=>j(t)),l.ipcMain.handle(`get-local-audit-events`,async(e,t)=>_e(t??200)),l.ipcMain.handle(`secure-store-token`,async(e,t)=>{try{return l.safeStorage.isEncryptionAvailable()?(N(`auth_token_encrypted`,l.safeStorage.encryptString(t).toString(`base64`)),P(`auth_token`),!0):(T.default.warn(`[SafeStorage] Encryption not available, falling back to config store`),N(`auth_token`,t),!0)}catch(e){return T.default.error(`[SafeStorage] store-token error:`,e),!1}}),l.ipcMain.handle(`secure-load-token`,async()=>{try{let e=M(`auth_token_encrypted`);if(e&&l.safeStorage.isEncryptionAvailable()){let t=Buffer.from(e,`base64`);return l.safeStorage.decryptString(t)}let t=M(`auth_token`);return t?(T.default.info(`[SafeStorage] Migrating plaintext token to encrypted storage`),l.safeStorage.isEncryptionAvailable()&&(N(`auth_token_encrypted`,l.safeStorage.encryptString(t).toString(`base64`)),P(`auth_token`)),t):null}catch(e){return T.default.error(`[SafeStorage] load-token error:`,e),null}}),l.ipcMain.handle(`secure-clear-token`,async()=>{P(`auth_token_encrypted`),P(`auth_token`)}),l.app.whenReady().then(async()=>{let e=u.default.join(__dirname,`../dist`);l.protocol.handle(`app`,t=>{let n=new URL(t.url),r=u.default.join(e,decodeURIComponent(n.pathname));(n.pathname===`/`||n.pathname===``)&&(r=u.default.join(e,`index.html`)),u.default.extname(r)===``&&(r=u.default.join(e,`index.html`));let i=u.default.resolve(r),a=u.default.resolve(e);return!i.startsWith(a+u.default.sep)&&i!==a&&(T.default.warn(`[Protocol] Path traversal blokkolva: ${t.url} → ${i}`),r=u.default.join(e,`index.html`)),T.default.info(`[Protocol] ${t.url} → ${r}`),l.net.fetch((0,d.pathToFileURL)(r).toString())}),T.default.info(`[App] Custom "app" protocol regisztrálva, distPath:`,e);try{await he()}catch(e){T.default.error(`[App] initDatabase failed`,e);let t=e instanceof Error?e.message:String(e);l.dialog.showErrorBox(`Adatbázis hiba`,`A helyi adatbázist nem sikerült inicializálni.\n\nRészletek:\n${t}`),l.app.quit();return}ht(),K.start(3e4),T.default.info(`[App] SyncEngine elindítva`)}),l.app.on(`will-quit`,()=>{K.stop(),T.default.info(`[App] SyncEngine leállítva`)}),l.app.on(`window-all-closed`,()=>{l.app.quit()}),l.app.on(`activate`,()=>{$===null&&ht()});