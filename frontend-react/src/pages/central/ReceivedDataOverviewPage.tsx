    ...
    <div className="h-full min-h-0 overflow-y-auto bg-slate-100">
      <div className="border-b border-slate-200 bg-white px-5 py-3">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          {/* FK-111 TBD-1: the CSV/Refresh actions belong to the reconciliation view only. */}
      ...
      <div className="border-b border-slate-200 bg-white px-5">
        <div className="flex gap-1" role="tablist">
          <TabButton
            ...
            testId="received-data-tab-reconciliation"
            label={t('centralReceivedData.tabReconciliation')}
            onClick={() => setView('reconciliation')}
          />
          <TabButton
            active={view === 'denominations'}
            testId="received-data-tab-denominations"
      ...
      {view === 'denominations' ? (
        ...
        <div className="space-y-4 p-4">
          <div className="grid grid-cols-2 gap-2 md:grid-cols-4">
            ...
            <Metric
              label="Értesített értéktár"
              value={result?.notifiedBranches ?? 0}
              tone="amber"
            />
          </div>
