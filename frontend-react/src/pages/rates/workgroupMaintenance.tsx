...
export const TILE_PALETTE: TilePaletteEntry[] = [
  { key: 'slate', label: 'Szürke', tile: 'bg-slate-100 border-slate-300 text-slate-800 hover:bg-slate-200', swatch: 'bg-slate-400' },
  { key: 'red', label: 'Piros', tile: 'bg-red-100 border-red-300 text-red-800 hover:bg-red-200', swatch: 'bg-red-400' },
  { key: 'orange', label: 'Narancs', tile: 'bg-orange-100 border-orange-300 text-orange-800 hover:bg-orange-200', swatch: 'bg-orange-400' },
  { key: 'amber', label: 'Borostyán', tile: 'bg-amber-100 border-amber-300 text-amber-800 hover:bg-amber-200', swatch: 'bg-amber-400' },
  { key: 'green', label: 'Zöld', tile: 'bg-green-100 border-green-300 text-green-800 hover:bg-green-200', swatch: 'bg-green-400' },
  { key: 'teal', label: 'Türkiz', tile: 'bg-teal-100 border-teal-300 text-teal-800 hover:bg-teal-200', swatch: 'bg-teal-400' },
  { key: 'sky', label: 'Égkék', tile: 'bg-sky-100 border-sky-300 text-sky-800 hover:bg-sky-200', swatch: 'bg-sky-400' },
  { key: 'indigo', label: 'Indigó', tile: 'bg-indigo-100 border-indigo-300 text-indigo-800 hover:bg-indigo-200', swatch: 'bg-indigo-400' },
  { key: 'purple', label: 'Lila', tile: 'bg-purple-100 border-purple-300 text-purple-800 hover:bg-purple-200', swatch: 'bg-purple-400' },
  { key: 'pink', label: 'Rózsaszín', tile: 'bg-pink-100 border-pink-300 text-pink-800 hover:bg-pink-200', swatch: 'bg-pink-400' },
]
 ...
 */
export function WorkgroupEditor({ mode, draft, setDraft, onSave, onCancel }: {
  mode: 'create' | 'rename'
