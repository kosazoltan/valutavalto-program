  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-8">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">{t('common.oldalNemTalalhato')}</h2>
        <p className="text-gray-600 mb-6">
          {t('common.aKeresettUrl')}<code className="bg-gray-100 px-2 py-1 rounded">{location.pathname}</code>{t('common.nemLetezik')}
          {t('common.lehetHogy')}
        </p>
        ...
        <div className="flex gap-3 justify-center">
          ...
          >
            <Home size={16} />{t('components.fooldal')}
          </Link>
        </div>
      </div>
    </div>
