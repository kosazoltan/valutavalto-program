...
describe('CLOSING_DENOMINATION_MENU (FR-KC-05)', () => {
  ...
  it('FR-KC-05 kényszer: az inaktív (szürkített) pontoknak nincs route-juk — nem indíthatók', () => {
    ...
    // FK-078 FR-8 / FKH-040: a WU / Foglaló inaktívan marad; az ÁFA aktiválva.
    expect(disabled.map((i) => i.id)).toEqual(['western-union', 'foglalo-keszlet'])
