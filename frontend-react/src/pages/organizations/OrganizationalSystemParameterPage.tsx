  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h1 className="text-xl font-bold flex items-center gap-2"><Settings />{t('organizations.szervezetiRendszerparameterek')}</h1>
        <button onClick={() => { setShowForm(true); setEditingId(null); setForm(emptyForm) }} className="form-button-primary"><Plus size={16} />{t('organizations.ujParameter')}</button>
      </div>
      ...
      <div className="form-panel flex gap-3 items-end">
        ...
        <span className="text-sm text-gray-500">{filtered.length} {t('organizations.parameter')}</span>
      </div>
