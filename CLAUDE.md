...
- **Verzió:** **v2.27.7** (2026-05-25 — FK-005/C1 Bank-törzs: a banki átadás-átvétel cél/forrás bankjai területi szűréssel. PR #846 `4a3c58181` admin-merged, production HEALTHY 200, V266 lefutott — verifikálva: 10 bank/1 cég). **Szerver-served → NINCS telepítő-rebuild** (a v2.27.6 telepítők a 2.27.7 frontendet szolgálják ki).
