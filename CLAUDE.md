...
- **Verzió:** **v2.27.3** (2026-05-25 — éles E2E follow-up: árfolyam-publikálás HTTP 500-fix [audit_log jsonb] + rate-maker sync-404 megszüntetés + service_version build-verzióból. PR #841 `ec49fcf33` + PR #842 `3163a84f4` admin-merged, production HEALTHY 200). **MERGED TELEPÍTŐ-BUILD KÉSZ** (Electron-natív sync-gating → MINOR).
