...
- **Verzió:** **v2.27.14** (2026-05-26 — vezetők Google-lel a PÉNZTÁR funkcióba is beléphetnek (pénztár-ellenőrzés). PR #856 `6bc965e4c` admin-merged, Sourcery „looks great", CI zöld, production HEALTHY 200. **Backend-only → szerver-served, auto-deploy, NINCS telepítő-rebuild** (a `validAppModes` a login-API válaszából jön).
