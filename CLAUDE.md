...
- **Verzió:** **v2.27.18** (2026-05-26 — belépés utáni program-mód választó a lokál terminálon (értéktáros/vezető több módba is beléphet). PR #860 `93ed349fa` admin-merged, CI zöld, production HEALTHY 200. **Penztar frontend (UI) változás → telepítő-rebuild kész és kézbesíthető.**
