...
- **Verzió:** **v2.27.6** (2026-05-25 — FK-005 értéktári jogosultság + átadás-átvétel csomag [„Értéktári jogosultság, átadás-átvételek" docx + 7 screenshot]. 3 PR admin-merged: #843 `d6028c2c5` + #844 `2dabe7e86` + #845 `536bdd684`, production HEALTHY 200). **TELJES TELEPÍTŐ-SZET ÚJRAÉPÍTVE v2.27.6** (user-kérés: a szállítás a pénztáros/értéktár ÉS a központi szekcióban is — konzisztens verzió).
