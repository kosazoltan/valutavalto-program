...
- **Verzió:** **v2.27.11** (2026-05-26 — auth-helyreállítás + jelszó=pénztáros szabály. **2 PR admin-merged**, production HEALTHY. **Üzleti modell (Kósa Zoltán):** a jelszó+felhasználónév = KIZÁRÓLAG pénztáros a lokális terminálokon (penztár/értéktár/értékszállító appMode — véletlenül se értéktáros); az értéktáros és vezetők CSAK Google-fiókkal (nincs jelszó amit ellopni/elfelejteni, a Gmail-fiók azonosítja a dolgozót a naplóban).
