...
- **Verzió:** **v2.27.12** (2026-05-26 — FK-003/004 Készlet pillanatkép (főértéktári élő készlet + napi forgalom). PR #854 `b7520d7d3` admin-merged, Codex CLEAN, CI zöld, production HEALTHY 200. **Szerver-served → NINCS telepítő-rebuild** (a főértéktár a frissítés gombbal azonnal látja).
