object MATPENZTAR: TMATPENZTAR
  ...
  object EKERPANEL: TPanel
    ...
    object KIADGOMB: TBitBtn
      ...
      Width = 481
      Height = 25
      Caption = 'E-KERESKEDELMI P'#201'NZEK KIAD'#193'SA'
      Font.Charset = EASTEUROPE_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Times New Roman'
  ...
  object EKERTABLA: TIBTable
    Database = EKERDBASE
    Transaction = EKERTRANZ
    BufferChunks = 1000
    CachedUpdates = False
    FieldDefs = <
      item
    ...
    StoreDefs = True
    TableName = 'EKERESKEDELEM'
    Left = 16
    Top = 288
    object EKERTABLADATUM: TIBStringField
      FieldName = 'DATUM'
      FixedChar = True
      Size = 10
    end
    object EKERTABLABIZONYLAT: TIBStringField
      FieldName = 'BIZONYLAT'
      FixedChar = True
      Size = 10
    end
    object EKERTABLAELOJEL: TIBStringField
      FieldName = 'ELOJEL'
      FixedChar = True
      Size = 1
    end
    object EKERTABLABANKJEGY: TIntegerField
      FieldName = 'BANKJEGY'
      DisplayFormat = '### ### ###'
    end
    object EKERTABLAPENZTAR: TIBStringField
      FieldName = 'PENZTAR'
      FixedChar = True
      Size = 4
    end
  end
  object EKERDBASE: TIBDatabase
    DatabaseName = 'C:\ERTEKTAR\DATABASE\VALUTA.FDB'
    Params.Strings = (
      'user_name=SYSDBA'
      'password=dek@nySo'
  ...
  object EKERTRANZ: TIBTransaction
    Active = False
    DefaultDatabase = EKERDBASE
    AutoStopAction = saNone
    Left = 104
    Top = 288
  end
