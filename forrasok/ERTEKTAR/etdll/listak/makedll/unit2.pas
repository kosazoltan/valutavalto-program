...
function idoszakrutin: integer; stdcall; external 'c:\ertektar\bin\idoszak.dll' name 'idoszakrutin';
function napikonyvelorutin: integer; stdcall; external 'c:\ertektar\bin\napkonyv.dll' name 'napikonyvelorutin';
function napikezdijrutin: integer; stdcall; external 'c:\ertektar\bin\napikezd.dll' name 'napikezdijrutin';
    ...
    begin
      ...
      if (_tipus='F') or (_tipus='U') THEN
        begin
          ...
          if _eztrb then
            begin
              if _penztarkod<>'TRB' then
                begin
                  ValdataQuery.Next;
                  continue;
                end;
              _penztarkod := trim(ValdataQuery.FieldByNAme('TRBPENZTAR').AsString);
            end;
...
begin
  _TPATH := 'c:\ERTEKTAR\bin\tablo.exe';
