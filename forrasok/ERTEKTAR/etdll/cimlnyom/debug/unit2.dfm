object CIMLETNYOM: TCIMLETNYOM
  ...
  object Panel1: TPanel
    ...
    object BitBtn1: TBitBtn
      ...
      Height = 25
      Cursor = crHandPoint
      Caption = #201'VV'#201'GI CIMLETEK NYOMTAT'#193'S P'#211'TL'#193'SA'
      TabOrder = 9
      OnClick = EvvegiNyomtatas
    end
  end
  ...
  object ETDATAQUERY: TIBQuery
    Database = ETDATADBASE
    Transaction = ETDATATRANZ
    BufferChunks = 1000
    CachedUpdates = False
    Left = 288
    Top = 16
  end
  object ETDATADBASE: TIBDatabase
    ...
    Params.Strings = (
      ...
      'lc_ctype=WIN1250')
    LoginPrompt = False
    DefaultTransaction = ETDATATRANZ
    IdleTimer = 0
    SQLDialect = 3
    TraceFlags = []
    Left = 328
  ...
  object ETDATATRANZ: TIBTransaction
    Active = False
    DefaultDatabase = ETDATADBASE
    AutoStopAction = saNone
    Left = 368
    Top = 16
  end
