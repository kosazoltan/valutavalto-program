...
var
  ...
  _txtOLvas: TextFile;
  _ptid,_ptnev: array[1..900] of string;
...
begin
  ...
  with ValutaQuery do
    begin
      ...
      sql.Add(_pcs);
      Open;
      _proskod := FieldByName('LASTPENZTAROS').asInteger;
      Close;
    end;
...
begin
  ...
  if _akcio='U' then
    begin
      ...
      _pcs := 'UPDATE UTOLSOBLOKKOK SET LASTPENZTAROS='+inttostr(_proskod);
      IbValutaParancs(_pcs);
...
begin
  ...
  _localpath  := 'c:\ertektar\irodak\ptarosok.txt';
