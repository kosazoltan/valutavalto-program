...
procedure TForm2.GetMegbizottData;
...
function TForm2.arfform(_arf: integer): string;
...
function TForm2.SZulform(_szi: string): string;
...
function Tform2.GetExPath: string;
