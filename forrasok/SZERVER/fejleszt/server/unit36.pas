...
//  _vanem: array[1..27] of string;
  _vatlag, _vBankjegy, _eAtlag, _eBankjegy: array[1..27,1..9] of real;
...
//  --------------------------------------------------
   ...
   for i := 1 to _vadarab do
     begin
       _excelTabla.Cells[i+4,1] := _dnem[i];
     end;
   _qq := 2;
   while _qq<37 do
     begin
