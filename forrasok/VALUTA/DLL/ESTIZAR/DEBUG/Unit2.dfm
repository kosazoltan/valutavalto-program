object MAKEPACK: TMAKEPACK
  ...
  object MATRICAQUERY: TIBQuery
    Database = MATRICADBASE
    Transaction = MATRICATRANZ
    BufferChunks = 1000
    CachedUpdates = False
    Left = 288
    Top = 184
  end
  object MATRICATABLA: TIBTable
    Database = MATRICADBASE
    Transaction = MATRICATRANZ
    BufferChunks = 1000
    CachedUpdates = False
  ...
  object MATRICADBASE: TIBDatabase
    Params.Strings = (
      'user_name=SYSDBA'
      'lc_ctype=WIN1250'
      'password=dek@nySo')
    LoginPrompt = False
    DefaultTransaction = MATRICATRANZ
    IdleTimer = 0
    SQLDialect = 3
    TraceFlags = []
    Left = 288
  ...
  object MATRICATRANZ: TIBTransaction
    Active = False
    DefaultDatabase = MATRICADBASE
