...
begin
  ...
  while _z<=_portdarab do
    begin
      ...
      if _z=1 then sendByteFile else SendKonstans;
...
// =============================================================================
                    procedure TFnyujsag.sendKonstans;
// =============================================================================

var _messlen: integer;

begin
  _message := _initsor + 'CHANGE - WESTERN UNION' + CHR(254);
  _messlen := 26;
