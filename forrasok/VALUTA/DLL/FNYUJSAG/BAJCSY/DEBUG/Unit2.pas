...
type
  TFnyUjsag = class(TForm)
    ...
    function arfform(_num: integer): string;
...
var
  ...
  _eurvet,_chfvet,_usdvet,_gbpvet: integer;
  _eurelad,_chfelad,_usdelad,_gbpelad: integer;
  _pcs,_mondat: string;
...
begin
  ...
  Arfnyitas(_pcs);
  _eurvet := ibQuery.fieldByName('VETELIARFOLYAM').asInteger;
  _eurelad:= ibQuery.FieldByName('ELADASIARFOLYAM').asInteger;

  _pcs := 'SELECT * FROM ARFOLYAM WHERE VALUTANEM='+chr(39)+'USD'+chr(39);
  Arfnyitas(_pcs);
  _usdvet := ibQuery.fieldByName('VETELIARFOLYAM').asInteger;
  _usdelad:= ibQuery.FieldByName('ELADASIARFOLYAM').asInteger;

  _pcs := 'SELECT * FROM ARFOLYAM WHERE VALUTANEM='+chr(39)+'GBP'+chr(39);
  Arfnyitas(_pcs);
  _gbpvet := ibQuery.fieldByName('VETELIARFOLYAM').asInteger;
  _gbpelad:= ibQuery.FieldByName('ELADASIARFOLYAM').asInteger;

   _pcs := 'SELECT * FROM ARFOLYAM WHERE VALUTANEM='+chr(39)+'CHF'+chr(39);
  Arfnyitas(_pcs);
  _chfvet := ibQuery.fieldByName('VETELIARFOLYAM').asInteger;
  _chfelad:= ibQuery.FieldByName('ELADASIARFOLYAM').asInteger;
  ibQuery.close;
  ibdbase.close;
end;
...
begin
  ...
  _utbytess := 3;
   ...
   _valsor := arfform(_chfvet)+'/'+arfform(_chfelad);
  Valsorbeiro(_valsor);

    _valsor := arfform(_gbpvet)+'/'+arfform(_gbpelad);
  Valsorbeiro(_valsor);

  _valsor := arfform(_usdvet)+'/'+arfform(_usdelad);
  Valsorbeiro(_valsor);

    _valsor := arfform(_eurvet)+'/'+arfform(_eurelad);
  Valsorbeiro(_valsor);
...
// =============================================================================
             function TFnyujsag.arfform(_num: integer): string;
// =============================================================================
...
begin
  _res := inttostr(_num);
  result := leftstr(_res,3)+'.'+midstr(_res,4,2);
end;
