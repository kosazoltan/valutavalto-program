...
//  _valsor := ' + HRK - RON - TRY - CNY - BGN - PLN - UAH - RUB - CZK - BAM - RSD NÁLUNK KAPHATÓ';
//  Valsorbeiro(_valsor);
...
begin
  ...
  if _bytesWritten=_bytefilehossz then
      ShowMessage('AZ ÁRFOLYAMOK SIKERESEN KI LETTEK KÜLDVE A FÉNYÚJSÁGRA !')
      ELSE
        ShowMessage('AZ ÁRFOLYAMOKAT NEM SIKERÜLT KIKÜLDENI A FÉNYÚJSÁGRA !');
end;
