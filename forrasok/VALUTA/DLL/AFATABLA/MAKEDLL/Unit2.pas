...
uses
  ...
  Dialogs, StdCtrls, Buttons, ExtCtrls, DB, DBTables, DateUtils,
...
function afatablarutin: integer; stdcall;
...
function afatablarutin: integer; stdcall;
begin
  Afatablazatform := TAfatablazatForm.Create(Nil);
  result := AfatablazatForm.showModal;
  AfaTablazatForm.Free;
end;
