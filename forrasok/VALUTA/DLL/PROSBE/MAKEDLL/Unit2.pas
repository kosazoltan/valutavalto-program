...
type
  TPROSBELEP = class(TForm)
    ...
    function Nul3(_etk: byte): string;
...
var
  ...
  _ptid,_ptnev: array[1..350] of string;
  _top,_left: word;
  _cords: string;
...
// =============================================================================
                 function Tprosbelep.Nul3(_etk: byte): string;
// =============================================================================

begin
  result := inttostr(_etk);
...
begin
  ...
  _localFile  := 'c:\valuta\irodak\ptarosok.txt';
