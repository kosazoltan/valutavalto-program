...
Add-ContentCheck -Area 'acceptance' -RelativePath 'package.json' -Pattern '"package:arfolyam-keszito"' -Expected 'Root arfolyam-keszito installer package script is wired'
...
$summary = [pscustomobject]@{
  ...
  pendingExternalEvidence = @(
    ...
    'Installer smoke on clean Windows VM for penztar, kozponti, and arfolyam-keszito clients',
