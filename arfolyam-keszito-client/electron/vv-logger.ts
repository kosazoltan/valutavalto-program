/**
 * EBC Valutavalto - Electron main process strukturalt logger (arfolyamkeszito (rate-maker)).
 *
 ...
 * (`clientContext: 'RFM'`), es valtozatlan felulettel exportal tovabb, hogy a
...
const handle = createVvLogger({ clientContext: 'RFM' })
 ...
 * A kliens-specifikus default context (`RFM`) mar be van allitva.
 */
