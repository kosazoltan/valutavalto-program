...
category: altalanos
original_path: Felmérés/Valuta/v2.0/Markdown/puzzle_folyamatok/README.md
doc_type: text
---

# README.md

**Kategoria:** altalanos  |  **Tipus:** text  |  **Meret:** 7.7 KB
**Eredeti utvonal:** `Felmérés/Valuta/v2.0/Markdown/puzzle_folyamatok/README.md`
...
8. [Meghatalmazott kezelés](./08_meghatalmazott_kezeles.md) - A meghatalmazottak kezelésének folyamatai
...
### Meghatalmazotti entitások

- `authorized_representative` - Meghatalmazottak adatai
- `authorization` - Meghatalmazások
- `allowed_operation` - Engedélyezett műveletek
- `representative_document` - Meghatalmazott dokumentumok
- `representative_log` - Meghatalmazott aktivitási napló
...
- `authorized_representative_ext` - Meghatalmazott kibővített nézet
- `authorization_ext` - Meghatalmazás kibővített nézet
- `representative_document_ext` - Meghatalmazott dokumentum kibővített nézet
