#!/usr/bin/env pwsh
# =============================================================================
# Valutavalto v2.5.49 Multi-Installer Acceptance Test Suite
# =============================================================================
# 3 telepítő párhuzamos validációja friss Windows VM-en (vagy clean rendszeren):
#   1. Penztar-Setup-2.5.49 (pénztáros + értéktáros közös)
#   2. Kozponti-Iranyitokozpont-Setup-2.5.49 (központi munkaállomás)
#   3. Arfolyamkeszito-Setup-2.5.49 (RFM főértéktárosi)
#
# Használat:
#   powershell -ExecutionPolicy Bypass -File installer-validation-suite-v2.5.49.ps1 -Component all
#   powershell -ExecutionPolicy Bypass -File installer-validation-suite-v2.5.49.ps1 -Component penztar
#   powershell -ExecutionPolicy Bypass -File installer-validation-suite-v2.5.49.ps1 -Component kozponti
#   powershell -ExecutionPolicy Bypass -File installer-validation-suite-v2.5.49.ps1 -Component rfm
#
