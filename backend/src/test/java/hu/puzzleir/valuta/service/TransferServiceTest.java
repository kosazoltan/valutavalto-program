...
class TransferServiceTest {
    ...
    void testCreate_multiLine_decreasesCashPerLine() {
        ...
        // 2x: (1) a cross-branch lock-ordering ELO-LOCK (CashLockOrdering, determinisztikus sorrend),
        // (2) a decreaseCashBalance no-op re-lock + mutacio — ugyanaz a sor, ket SELECT ... FOR UPDATE.
