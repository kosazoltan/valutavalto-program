...
@Slf4j
public class ErrorLogExceptionHandler {

    @Autowired(required = false)
    private ErrorMailerService errorMailerService;

    /**
     * 404 - NoResourceFoundException: let Spring handle it naturally as 404.
     * MUST NOT return 500 — this breaks Render health check on /actuator/health.
     */
