...
public class Transfer {
     ...
     * {@code @CreatedDate} auditing tölti — a {@link Transfer}-t építő {@code TransferService.create}
     * szándékosan nem állítja be kézzel. Ha az auditing egy adott kontextusban nincs bekapcsolva,
     * az INSERT NOT NULL-sértéssel elhasal, holott a mentendő adat maga hibátlan.
     *
