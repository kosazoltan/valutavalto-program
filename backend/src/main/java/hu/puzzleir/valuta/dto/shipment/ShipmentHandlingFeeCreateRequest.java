...
@AllArgsConstructor
@Builder
public class ShipmentHandlingFeeCreateRequest {

    @NotNull(message = "Az átadó (forrás pénztár) megadása kötelező")
    private UUID fromBranchId;

    @NotNull(message = "Az átvevő megadása kötelező")
    private UUID toBranchId;

    @NotNull(message = "A kezelési költség összege kötelező")
    @DecimalMin(value = "1", message = "A kezelési költség összege pozitív kell legyen")
