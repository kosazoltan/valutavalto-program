...
WHERE param_key = 'DAILY_CUSTOM_FEE_LIMIT';

-- Ha nem létezik (pl. friss install), beszúrjuk
INSERT INTO system_parameters (id, param_key, param_value, param_type, category, description)
...
WHERE NOT EXISTS (SELECT 1 FROM system_parameters WHERE param_key = 'DAILY_CUSTOM_FEE_LIMIT');
