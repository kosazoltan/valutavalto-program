...
// =============================================================================
  ...
  // Kiolvassa a távoli gyüjtő 2 paraméterét: a Táblanevet és Sorszámot
  ...
  // Kis- vagy nagyügyfél szerveren lévő gyüjtőjének update-e:
...
begin
  logirorutin(pchar('Ugyfel adatok beolvasasa a VTempből'));
...

{
     Kedvezmény word:
        ...
        HIGH BYTE:  256 - KEZELÉSI DÍJ GOMBBAL FELEZÉSE            JELSZAVAS
                   ...
                   1024 - ÜGYVEZETŐ JELSZAVAS ELENGEDÉS            JELSZAVAS
