...
// A havi nyitó értékek beolvasása
  ...
  // A ma reggeli nyitók kiszámitása, a többi mező nullázva:
   for z := 0 to _valutaDarab-1 do
    begin
  ...
  // A mai napi forgalmak bedolgozása a bevétel, kiadás mezőibe
...
begin
  ...
  while not ibQuery.Eof do
    begin
      ...
      // Vételnél és eladásnál a forint a valutával ellentétesen nő vagy csökken
