...

{
   ...
   STATUS = 1-> Ügylet függőben,
            2-> Ügylet időben rendezve
            3-> Ügylet más időpontban rendezve
...
////////////////////////////////////////////////////////////////////////////////
////////////    E-MAIL-EK KÜLDÉSE A FELÜGYELŐKNEK  /////////////////////////////
// =============================================================================
...
begin
  if not bizonylatseek then
    begin
      Showmessage('Nincs függőben lévő foglaló');
      exit;
    end;
...
////////////////////////////////////////////////////////////////////////////////
////////////////   MEGNÉZI HOGY VAN-E FÜGGÖBEN LÉVŐ FOGLALÓ ////////////////////
// =============================================================================
...
begin
  ...
  _status := 2;  // A ügylet lerendezve időben

  VisszaFizetoProcedura;
end;

////////////////////////////////////////////////////////////////////////////////
//////////////  A HATÁRIDŐ ELTÉR A MEGÁLLAPODÁSTÓL      ////////////////////////
// =============================================================================
                           procedure TFoglalo.MasidoPont;
// =============================================================================

begin
  logirorutin(pchar('A határidő eltér az eredetitől'));
...
////////////////////////////////////////////////////////////////////////////////
///////////  HATÁRIDŐ NEM STIMMEL - BEFEJEZEM A TRANZAKCIÓT  ///////////////////
// =============================================================================
...
////////////////////////////////////////////////////////////////////////////////
////////////  HATÁRIDŐ NEM STIMMEL - DE MÉGIS MEHET A TRANZAKCIÓ  //////////////
// =============================================================================
                 procedure TFoglalo.MegisMostGombClick(Sender: TObject);
// =============================================================================

begin
  // NINCS MÉG HATÁRIDŐ - MÉGIS MOST FIZETEK:
...
////////////////////////////////////////////////////////////////////////////////
///////////   MEG KELL INDOKOLNI A HATÁRIDŐCSUSZÁST    /////////////////////////
// =============================================================================
...
begin
  ...
  _status := 3;  // Más határidőbeli visstafizetés
  VisszaFizetoProcedura;
end;
...
begin
  // A FOGLALOKESZLET-ből kiveszi a foglaló értékét
...
begin
  ...
  _pcs := _pcs + chr(39) + _hatarido + chr(39) + ',';   // eredeti határidő
  ...
  _pcs := _pcs + chr(39) + _foglaloValutanem + chr(39) + ',';   // ebből a pénznemből
