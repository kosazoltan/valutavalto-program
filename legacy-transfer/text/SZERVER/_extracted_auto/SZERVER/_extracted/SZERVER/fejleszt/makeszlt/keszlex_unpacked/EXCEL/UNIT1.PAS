...
var
  ...
  _korzetValtodarab: array[1..8] of byte;         // Egyes körzetekben lévö élő irodák száma

  _eloIrodadarab   : integer;                     // Ennyi élő iroda küldött adatokat
  _eloIrodaSor     : array[1..150] of byte;       // A fentiek irodaszámai
  _valutakeszlet   : array[1..150,1..20] of integer; // Az élőirodák valutakészletei
