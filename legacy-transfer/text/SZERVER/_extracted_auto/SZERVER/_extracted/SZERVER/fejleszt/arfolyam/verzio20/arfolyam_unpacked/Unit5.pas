...
begin
  ...
  Memo1.Lines.add('Az ARFDATA.DAT file rögzítése a lokális számítógépen');
  Indito.Enabled := true;
end;
...
begin
  ...
  {
  inc(_irodadarab);
  _ptarszam[_irodadarab] := 4;
  _ptarnev[_irodadarab] := 'PECS TESCO-2';
  _PTARCSOP[_IRODADARAB] := 0;
  }


  Byteiras(15);   // AZ AKTUÁLIS VERZIÓ SZÁM:
