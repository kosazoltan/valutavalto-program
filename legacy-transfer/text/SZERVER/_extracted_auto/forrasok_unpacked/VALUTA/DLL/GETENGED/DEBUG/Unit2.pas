...
//               1=engedélyezett VTEMPBE: forras,engedélyező
...
//  _etipus := 2;  ////   TESZT  !!!!!!!!!!!!!!!
  ...
  logirorutin(pchar('Az engedelyező megadásának indoka: '+ _mess));
...
begin
  ...
  _mess := 'Forrás= '+lowercase(_forras)+', Engedélyező= '+lowercase(_engedelyezo);
