...
begin
  ...
  _menucim[6] := 'CÉGNEK TÖRTÉNŐ ÁFA-KIFIZATÉS';
...
begin
  ...
  // végül Kiteszi a visszatérités bekérőpaneljét:
   ...
   // Az elsö bekérendő adat  a számlaszám
...
begin
  ...
  // A kért időszak alapján meghatározza a Gyüjtőtábla nevét:
  _farok := Nulele(_kertev-2000,2)+Nulele(_kertho,2);
  _wafaTablaNev := 'WAFA' + _farok;  // pl. 'WAFA0802' = 2008 FEBRUÁR

  // Ha a kért gyüjtő nem létezik, akkor nincs tovább
  ...
  // Beállitja a tallozó tábla paramétereit a gyüjtő adatbázisra
  ...
  // A karton kijelző ürlapot kiteszi egy ablakba:
  ...
  // Beolvassa az első rekordot:
  WafaRekordRead;

  // Kijelzi az első rekordot, vezérlés a ListHideedit-nek
  WafaKartonDisp;
end;
...
begin
  ...
  ShowMessage('NINCSENEK ADATAIM A KÉRT IDŐSZAKRÓL');
end;
