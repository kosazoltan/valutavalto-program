...
begin
  ...
  _voltshk   := False;  // Sajáthatáskörü jelző flag alapra
  ...
  // Ha már mind az 5 lehetőség kimerült a függöny legördül:
...
begin
  if _sajatHataskoru>4 then
    begin
      Showmessage('A MAI NAPON MÁR 5 SAJÁTHATÁSKÖRÜ BIZONYLAT VOLT. TÖBBRE NINCS LEHETŐSÉG');
      Exit;
    end;
