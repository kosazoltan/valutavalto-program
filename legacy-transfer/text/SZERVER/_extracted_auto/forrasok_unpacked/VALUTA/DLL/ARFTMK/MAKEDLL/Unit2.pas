...
begin
  ...
  if _aktelszarf=0 then
    begin
      GombtakaroPanel.Visible := false;
      ShowMessage('AZ ELSZÁMOLÓ ÁRFOLYAMOKAT LE KELL TÖLTENI A SZERVERRŐL');
      SiccGombClick(NIL);
      Exit;
    end;
  ...
  // Itt a előjön a módosító panel az összes objektumával:
  ...
  // Elsőnek a vételi-árfolyamot ajánlja fel a módositásra:
