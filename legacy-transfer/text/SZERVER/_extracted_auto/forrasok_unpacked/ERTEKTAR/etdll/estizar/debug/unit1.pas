...
begin
  ...
  (* Elölről kezdjük az adatbázis átnézését *)
  ValdataQuery.First;

  while not ValdataQuery.Eof  do
    begin
      (* A rekord összes mezőjét lekódolja és felirja *)
      for _q := 1 to _aktMezoDb do
        begin
          ...
          Beiras(_aktKod,_adat); // a mező adatát beirja a csomagba
        end;
...
begin
  case _kKod of
    ...
    8: begin   //egy időstring felirása
     ...
     begin
       ...
       while not MatricaQuery.Eof do
         begin
           ...
           _irany := 45;  // minusz
           if _ft<0 then  // forditott előjelek !!!!!
             begin
               _irany := 43;  // plusz +
               _ft := abs(_ft);
             end;
