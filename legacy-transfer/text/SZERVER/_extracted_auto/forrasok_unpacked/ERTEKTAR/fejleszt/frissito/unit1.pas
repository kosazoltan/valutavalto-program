...
begin
  ...
  Memo1.Lines.add('Az internet ellenőrzése .....');
  ...
  Memo1.Lines.Add('Frissito.ini letöltése a szerverről ...');
...
begin
  ...
  if leftstr(_mm,4)='@bin' then
    begin
      ...
      Memo1.Lines.add('A frissitendő file-ok listája');
      _cc := 0;
      while true do
        begin
          _mondat := getNemuresMondat;
  ...
  if leftstr(_mm,9)='@newfield' then
    begin
      Memo1.Lines.add('Az új adatmezők listája');
...
begin
  ...
  while _qq<_nfdb do
    begin
      ...
      Memo1.Lines.add('Új mező hozzáadása: ' + _aktmezonev);
