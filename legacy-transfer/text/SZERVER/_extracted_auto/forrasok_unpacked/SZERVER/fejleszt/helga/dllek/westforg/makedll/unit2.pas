...
begin
  ...
  if (_evIndex=1) and ((1+_hoIndex)>_aktHo) then
   ...
   Memo.Lines.Add('    MEGKEZDEM AZ ELLENŐRZÉST');
    ...
    begin
      ...
      while _aktNap<=_haviNap do
        begin
          ...
          _forgHufKi := _bankHufKi + _bankHufKi;
...
begin
  ...
  case _hibaSs of
    1: _mess := 'USD nyitó nem azonos az elöző napi záróval';
    2: _mess := 'HUF nyitó nem azonos az elöző napi záróval';
...
begin
  ...
  // --------------------------------------------------------------------------
   ...
   // _munkanap: elsejétől a hó utolsó napjáig:
