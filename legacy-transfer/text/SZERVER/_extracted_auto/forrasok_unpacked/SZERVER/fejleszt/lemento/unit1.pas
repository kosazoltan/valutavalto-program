...
begin
  ...
  // Várom, hogy az időszakot konfirmálja:
...
begin
  ...
  if (_tolDatumstring>_igDatumString) then
    begin
      ShowMessage('A KEZDŐ DÁTUM NAGYOBB A VÉGSŐ DÁTUMNÁL');
      exit;
    end;
  ...
  while True do
    begin
      ...
      // Felirjuk az első havi adatokat:

      EgyHonapIro;
      // Jöhet a következő hónap:
...
begin
  ...
  while not BlokkQuery.Eof do
    begin
      ...
      // Beolvassa a fejből az időt, a bizonylatszámot,és stornó mezőt:
...
begin
  ...
  if _aktStorno>1 then _aktblokknum := '#' + midstr(_aktblokknum,4,6) +'#'
