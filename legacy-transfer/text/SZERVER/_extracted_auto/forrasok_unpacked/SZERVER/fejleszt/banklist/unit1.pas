...
begin
  ...
  while not utquery.eof do
    begin
            ...
            begin
              ...
              while not Uf19query.eof do
                begin
                  ...
                  // Jöhet a következő 2019-es váltás:
      ...
      // Jöhet a következő név az exceltáblából:
