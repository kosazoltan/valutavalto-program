...
begin
  ...
  // Kis négyzet a bal-felső sarokban:
...
begin
  ...
  // Ha éjjel 1 óra és 2 óra között van az idő és még nem kérte az újrainditást
    ...
    begin
      if not FileExists(_rebootPath) then
        begin
          ...
          Closefile(_txtiras);
          Logbair('1 óra elmúlt - űjrainditást elöjegyezni !');
...
begin
  ...
  while _qq<_dirdb do
    begin
      ...
      // Az aktdirből törli a régi 'C1'-kiterjesztésü fileokat, ha azok
      // 4 napnál régebbiek:
