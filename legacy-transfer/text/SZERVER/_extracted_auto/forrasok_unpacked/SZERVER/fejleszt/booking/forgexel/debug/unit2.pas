...
var
  ...
  _kftnevek : array[1..2] of string = ('Best Change','Expressz Zalog');
  ...
  _korzetDb      : array[1..2] of byte = (8,1);
  _kftKorzetSor  : array[1..2,1..3] of byte;
...
begin
  ...
  processPanel.Caption := 'Adatok előkészítése';
...
begin
  if _korzetIndex=1 then _Focim := 'EXCLUSIVE BEST CHANGE KFT '
