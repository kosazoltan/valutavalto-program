...
// Az új vezető nevének beirása után entert nyomott:
...
// Az új vezető emailcime után entert nyomott:
...
// Rákattintott az új vezető rendben gombra:

begin

  // Ellenőrzi. hogy van-e új név:
  ...
  // ellenőrzi, hogy van-e új emailcim:
  ...
  if _kod=0 then
    begin
      ShowMessage('AZ ÚJ VEZETŐ NINCS A DOLGOZÓI ADATBÁZISBAN !');
      UjVezetoPanel.Visible := false;
      exit;
    end;

  // Rögziti az új vezetőt az email adatbázisban:
  ...
  // Újranyitja a vezetői adatbázist és rácsot:
...
begin
   // Penztárosok között megkeresi a most megadott vezető nevét:
