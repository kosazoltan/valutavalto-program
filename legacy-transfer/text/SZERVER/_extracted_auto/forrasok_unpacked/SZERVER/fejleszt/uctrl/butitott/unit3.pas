...
begin
  ...
  while _pt<=168 do
    begin
      ...
      // Ha az adatbázis üres, jöhet a következő pénztár:
      ...
      while not vquery.eof do
        begin
          ...
          // Ha plomba nem a nevtabla+sorszam -> jöhet e következő rekord:
          ...
          // Ha itt a sorszám zéró, akkor jöhet a következő rekord:
          ...
          with Vquery do
            begin
              // A főtömbbe beirja a fejblokk értékes adatokat:
          ...
          // A főtömbbe beirja a névtáblát vagy sorszámát
  ...
  // Összesen ennyi fejrekord van a főtömbben:
  ...
  // A főtömb összes rekordját felirja
...
begin
  ...
  // Végigmegy az összes rekordot 1-től a blokkdarab-ig:
