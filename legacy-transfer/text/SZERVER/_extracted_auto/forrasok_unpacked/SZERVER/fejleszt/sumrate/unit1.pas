...
begin
     ...
     // Megnyitja az ARFE táblát a föértéktárosi és értéktárosi engedményre
      ...
      while not vquery.Eof do
       begin
         ...
         // Az ARFE-ből kiolvasott rekordot, beirja a COMPRATE-be:
      ...
      // Jöhet a következö szám a 150-ből
  ...
  while not Permquery.eof do
    begin
      ...
      // Az COMPRATE táblában megkeresi a rekordnak megfelelő rekordokat:
      ...
      // Megnézi, hogy van-e megfelelő rekord a COMPRATE táblában:
