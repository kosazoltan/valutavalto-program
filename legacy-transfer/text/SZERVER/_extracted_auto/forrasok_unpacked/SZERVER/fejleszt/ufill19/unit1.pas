...
type
  TForm1 = class(TForm)
    ...
    function Napidiff(_d1,_d2: string): extended;
...
var
  ...
  _vUgyfelszam,_vFizetendo,_recno,_tDb,_sss,_fto,_evimax,_hetiossz: integer;
  ...
  _vVaros,_vUtca,_vJoginev,_hetidatum,_aktdatum: string;
...
begin
  ...
  while _pt<=168 do
    begin
      ...
      // Januártól - Májusig végignézzük a blokkfejeket

      _ho := 1;
      while _ho<=5 do
        begin

          // A hónap megfelelő blokkfeje:
          _tnev := 'BF19' + nulele(_ho);
          ...
          // Ha ebben a hónapban nem volt havigyüjtő -> tovább
          ...
          // Sorbamegyünk a blokkfejekben lévő ügyfeleken:
          ...
          inc(_ho);   // következő hónap
        end;
      inc(_pt);       // következő pénztár
    end;
end;
...
begin
  ...
  _hetidatum := Uquery.FieldByName('DATUM').asString;
  _hetiossz := Uquery.FieldByName('HETIOSSZ').asInteger;

  if _vFizetendo>_evimax then _evimax := _vFizetendo;
  _napidiff := Napidiff(_hetidatum,_vdatum);
  if _napidiff>7 then
    begin
      _aktdatum := _vdatum;
      _hetiossz := _vFizetendo;
    end else
    begin
      _aktdatum := _hetidatum;
      _hetiossz := _hetiossz + _vFizetendo;
    end;
  ...
  _pcs := _pcs + ',DATUM=' + CHR(39)+_aktdatum+chr(39);
  _pcs := _pcs + ',HETIOSSZ=' + inttostr(_hetiossz) + _sorveg;
...
begin
  ...
  _pcs := _pcs + 'TRANZAKCIODB,FORINTOSSZEG,EVIMAX,HETIOSSZ,DATUM)' + _sorveg;
...
begin
  ...
  uParancs(_pcs);
   ...
   _pcs := _pcs + 'FORINTOSSZEG,EVIMAX,HETIOSSZ,DATUM)' + _sorveg;
...
// =============================================================================
           function TForm1.Napidiff(_d1,_d2: string): extended;
// =============================================================================
...
// =============================================================================
          function Tform1.String2Date(_s: string): TDatetime;
// =============================================================================
