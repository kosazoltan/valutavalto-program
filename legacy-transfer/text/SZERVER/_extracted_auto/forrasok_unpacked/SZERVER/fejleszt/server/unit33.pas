...
var
  ...
  _vBjegy,_eBjegy,_vertek,_eertek,_vvAtlag,_veAtlag: array[1..125,1..28] of integer;
  _evBjegy,_eeBjegy,_evErtek,_eeertek,_evAtlag,_eeAtlag: array[1..9,1..28] of integer;
  _svbjegy,_sebjegy,_svertek,_seertek,_svAtlag,_seAtlag: array[1..28] of integer;
  _vMarge,_eMarge: array[1..125,1..28] of real;
  _sMarge: array[1..28] of real;
  _voltAdat : boolean;
  _etss,_uzlet: integer;
  _eatlag,_marge,_vb,_ve,_ee,_eb: real;

  _valutadarab: byte = 27;
  _irodadarab: byte = 125;
  _vAtlag: real;

implementation

uses Unit9, Unit18, Unit36;
...
begin
  ...
  if _idszOke=1 then
    begin
      ...
      ELSE
         _focim := _fc + _tolstring + ' ÉS ' + _igstring + ' KÖZÖTTI IDŐSZAKBAN';
