...
begin
  ...
  Tranzcombo.Items.add('   VÉTEL   ');
  Tranzcombo.Items.add('  ELADÁS   ');
  Tranzcombo.Items.add(' KONVERZIÓ ');
...
begin
  ...
  case _lob of
     0: _dekarf := '-';
    16: _dekarf := 'ÉRTÉKTÁROSI';
    32: _dekarf := 'FŐÉRTÉKTÁROSI';
    64: _dekarf := 'ÜGYVEZETŐI';
   128: _dekarf := 'JUTALÉKMENTES';
  end;

  case _hib of
     0: _dekkezd := '-';
     256: _dekkezd := 'FELEZÉS';
     1024: _dekkezd := 'ELENGEDÉS';
     2048: _dekkezd := 'CSÖKKENTÉS';
   end;
end;
