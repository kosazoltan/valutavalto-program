...
var
  ...
  // A 6 FŐBB VALUTA NAPI FORGALMI ADATAI:
    ...
    begin
      ...
      for j := 1 to 31 do
        begin
          ...
          //  Az 5 főbb valuta napi vétele és eladása:
      ...
      // Az 5 főbb valuta elözöhavi összes eladása, ill. vétele
...
begin
  ...
  while not Daybookquery.Eof do
    begin
      ...
      UzenoPanel.Caption := 'Elözőnapi- és haviadatok felirása';
      UzenoPanel.REPAINT;
...
begin
  ...
  if _recno=0 then
    begin
      ...
      // Megnézzük az elöző havi adatbázist ........
      ...
      // ha nincs elözőhavi wzar-tábla - akkor nincs adat
    ...
    begin
      ...
      while _pp<=_aktPtdb do
        begin
          ...
          // Elöző havi munkanapok száma:

          Byteiras(_eMunkanapok[_penztar]);

          // Elöző havi vétel és eladás:
