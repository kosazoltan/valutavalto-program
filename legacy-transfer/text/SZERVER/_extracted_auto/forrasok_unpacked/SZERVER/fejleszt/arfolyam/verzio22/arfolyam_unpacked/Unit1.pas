...
var
  ...
  _bcsabaHost : string = '185.43.207.99';
  _bcsabaPort : integer = 21100;

  _pecsport   : integer = 21;
  _pecsHost   : string = '89.135.183.117';
  ...
  _jErtek,_jfuggveny,_kertek,_kfuggveny: array[1..54,1..27] of string;
  _lErtek,_lfuggveny,_mErtek,_mFuggveny: array[1..54,1..27] of string;
  _nErtek,_nfuggveny,_oErtek,_oFuggveny: array[1..54,1..27] of string;
  _pErtek,_pfuggveny,_qErtek,_qFuggveny: array[1..54,1..27] of string;
  _rErtek,_rfuggveny,_sErtek,_sFuggveny: array[1..54,1..27] of string;

  _jBetuszin,_jHatterSzin,_kBetuszin,_kHatterszin: array[1..54,1..27] of TColor;
  _lBetuszin,_lHatterSzin,_mBetuszin,_mHatterszin: array[1..54,1..27] of TColor;
  _nBetuszin,_nHatterSzin,_oBetuszin,_oHatterszin: array[1..54,1..27] of TColor;
  _pBetuszin,_pHatterSzin,_qBetuszin,_qHatterszin: array[1..54,1..27] of TColor;
  _rBetuszin,_rHatterSzin,_sBetuszin,_sHatterszin: array[1..54,1..27] of TColor;

  _wErtek,_wfuggveny: array[1..27,1..9] of string;
  _wBetuszin,_wHatterszin: array[1..27,1..9] of TColor;
