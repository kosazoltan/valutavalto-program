...
begin
  // Kezdő és végső dátumok feldolgozása:

  DatumDisplay;
  if _toldatum>_igdatum then
    begin
      ShowMessage('A KEZDŐ-DÁTUM NAGYOBB AZ UTOLSÓ DÁTUMNÁL !');
      Exit;
    end;
  ...
  // Végig megyünk az összes pénztáron
   ...
   while _pt<=150 do
     begin
       ...
       // Az aktuális adatbázist elérő útvonal:

       _fdbPath := 'c:\receptor\database\v' + inttostr(_pt)+'.fdb';

       // Ha nincs adatbázis - jöhet a következő pénztár:
       ...
       // Az összes időszakra eső adatbázist meg kell vizsgálni:
...
begin
  ...
  // Ha nem volt ebben a hónapban váltás - jöhet a következő hónap
  ...
  // Megnyitjuk a Blokfejeket az időszakon belül.(VEK tipusokra, storno=1)
