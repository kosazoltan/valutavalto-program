...
begin
  ...
  MNBArfolyamLetoltes;
  IdoszakBeolvasas;   // -tol+-igstr,szürők,farok tablanevek

  //  A hyüjtőtáblák kiüritése:
...
// ========================  IRODÁK CIKLUSA ====================================
  ...
  while _qq<=_irodaDarab do    // az összes nyitott iroda fdb-n megy végig
    begin
      ...
      // következö pénztár alapadatai a pénztárak tömbjeiből:
  ...
  if not BlokkTabla.exists then
    begin
      ...
      if _kdatum='' then exit;
       ...
       // A cimlettábla neve az elöző havié:
    ...
    begin
      ...
      if _recNo=0 then
        begin
          ...
          // Bekéri az elöző-havi cimlettábla utolsó dátumát:
          _kdatum := MulthaviUtolsoCimNap();
...
begin
  ...
  // At elöző havi cimlettábla neve:
  ...
  // Ha elöző hőnapban sincs cimlettábla -> vissza: üres string
  ...
  //  Megnyitja az elözőhavi cimlettáblát Dátum sorrendben:
...
begin
  Alcimpanel.Caption := 'Készlet körzetösszesitő rögzitése';
  AlcimPanel.repaint;
...
begin
  ...
  Alcimpanel.caption := 'Körzet készletösszesitő nullázása';
  AlcimPanel.repaint;
