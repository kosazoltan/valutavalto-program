...
begin
  Memo1.Lines.add('Megkisérelem a kijelző letöltését');
...
begin
  ...
  Memo1.Lines.Add('Az új kijelző letöltése');
  ...
  IF RESULT then Memo1.Lines.Add('Sikeresen letöltve az új kijelző')
  else Memo1.Lines.Add('Sikertelen kijelző csere');
...
begin
  ...
  IF KijelzesLeallitas THEN Memo1.Lines.Add('A kijelzőt sikerült leállitani');
  Sleep(400);
  ...
  ELSE memo1.Lines.Add('Nem sikerült törölni a kijelzőt');
