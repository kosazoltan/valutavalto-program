...
// őőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőőő
...

{
  ...
  -------------  Output: ugyfeltipus=K,ugyfelszam,nevtabla,sorszam
           ...
           result : -1 = Tranzakció STOP ! Nem folytatható !
                     ...
                     2 = Kötelező a teljes azonositása
...
begin
  ...
  TombMeghatarozas;
  AlapraAllitas;
  ParaBeolvasas;  // fizetendo,tipus,konverzio a VTEMP-ből
  VtempNullazo;
  ...
  if _securlevel=1 then logirorutin(pchar('Kötelező az azonosítás'));
...
begin
  ...
  if _bill=13 then
    begin
      ...
      if (_tag=12) and (_kulfoldi=0) then       // belföldi = 11 mező
        begin
          ActiveControl := NaturAdatOkeGomb;
          exit;
        end;

      if _tag=13 then                          // külföldi = 12 mező
        begin
          Activecontrol := NaturAdatOkeGomb;
          exit;
        end;
...
begin
  ...
  if not DatumCtrl(_Szulido) then
    begin
      logirorutin(pchar('Hibás születési idő'));
      SzulidoEdit.Text := '';
      Mezovaltozas;
...
begin
  ...
  // A jogi adatokat bekérő editek előkészitése az adatbevitelre
   ...
   // Ellenörzi a jogi editek kitöltését:
    ...
    if _ww<6 then
      begin
        if _voltjogiF6 then _jogimezovaltozott := True;
        Kepvisnevedit.Text := '';
        logirorutin(pchar('Hibás képviselőnév'));
    ...
    if _ww<3 then
      begin
        if _voltjogiF6 then _jogimezovaltozott := True;
        KepvisBeoEdit.Text := '';
        logirorutin(pchar('Hibás képviselő beosztás'));
...
// =================== ADATOK BEOLVASÁSA A KÉPERNYŐRŐL =========================
...
// =============================================================================
//      Vtemp-ből beolvassa: fizetendo,tipus éd konverzio
...
{
  A kötelező adatok: _ugyfeltipus        = 'N' VAGY 'J'
