...
var
  ...
  _aktdnem,_aktCimletSor,_zaszloPath,_mondat,_aktdnev,_akttext,_pcs: string;
  ...
  _aktedit: TEdit;
  _LPath : string = 'c:\valuta\cimlprnt.txt';
...
begin
  ...
  // A kiválasztott deviza cimletezésének előkészítése:
  ...
  // Beirja a kiválasztott deviza nevét a cimletező táblába:

  dnemPanel.Caption := _aktDnem;

  // A deviza országának zászlóját is beépiti a táblázatba:

  _zaszloPath       := 'c:\valuta\flags\'+_aktdnem+'.jpg';
  ...
  // Kitölti a teljes táblát a választott devizának megfelelő cimletekkel:
  ...
  // Ha volt valamennyi cimletezés -> akkor rögzithető a cimlet:
...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//          Megnyomta a cimlet-rögzitő gombot - Cimlet rendben                //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
// =============================================================================
...
begin
  ...
  _aktdnem := _dNem[_aktdnemIndex];
  _aktdnev := _dnev[_aktdnemindex];
  _mondat  := _sorveg + '  '+_aktdnem + ' - ' + _aktdnev + ' cimletezése' + _sorveg;
