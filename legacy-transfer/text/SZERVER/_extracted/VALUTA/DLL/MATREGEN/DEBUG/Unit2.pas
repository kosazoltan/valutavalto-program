...
begin
  ...
  // A napi összesitőről törli a regenerálás napi rekordot !

  _pcs := 'DELETE FROM NAPIOSSZESITO WHERE DATUM='+chr(39)+_trDatum+chr(39);
  TradeParancs(_pcs);

  // Most megnyitja a napi összesitőt, ahol az utolsó zárás lesz a nyitó !
  ...
  // A napi összesitőben summázza a hónapra vonatkozó adatokat:
