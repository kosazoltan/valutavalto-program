...
// Ha nincs internet, akkor nem lehet dolgozni:
  ...
  // Előkésziti a log-file-t használatra
  SetLogFile;

  // ---------------------------------------------------------------------------

  // Külső dll regenerálja a mai összesítő táblákat

  matricaregeneralo;

  // ---------------------------------------------------------------------------
  // Ha a terminalid nem 4 betüből áll, akkor nincs kitöltve a tanusitvány:
...
begin
  ...
  // ------------ A log-tábla előkészitve irásra ------------------------
