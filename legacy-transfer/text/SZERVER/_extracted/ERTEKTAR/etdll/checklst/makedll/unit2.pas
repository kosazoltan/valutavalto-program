...
var
  ...
  _aktdatum: TDatetime;
  _Paratipus: integer;
  _checkdir: string = 'c:\ERTEKTAR\check';
...
begin
  ...
  _m[8] := 'Bizonylatok párosítása, lefűzése.';
 ...
 _m[14] := 'Egyedi árfolyamok ellenőrzése, továbbítása az érintetetteknek';
 _m[15] := 'Nagy ügyféltáblák begyüjtése, összesítése, továbbítása érintetteknek (eseti)';
 _m[16] := 'Könyvelések lenyomtatása, lefűzése, adatainak ellenőrzése';
