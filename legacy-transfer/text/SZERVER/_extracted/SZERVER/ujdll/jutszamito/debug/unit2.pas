...
begin
  // Az idő-intervallum meghatározása:
     ...
     begin
       ...
       if vfejtabla.Exists then
         begin
           ...
           // Most megnyitja a blokkok tábláját (storno=1,tipus=V-E-K,időintervallum)
           ...
           Uzenopanel.repaint;
            ...
            // Létező pénztár, létező blokkfej tábláját megnyitja:
           ...
           while not vFejQuery.Eof do
             begin
               ...
               // Az idpointer a következő elemre mutat, ha ez egy új elem:
               //
         ...
         begin
           ...
           while not vFejquery.eof do
             begin
               ...
               // Ha a tranzakció forintban van az összeg a banykjegy mező
...
begin
  ...
  // Ha ez a legelső index ,akkor ez a nulladik elem a tömbben.
