...
begin
  ...
  // A szigno elsö betüjének meghatározása: (Lehet kettős betü is)

  _sign1 := ektelenito(_sign1);

  // A szigno hétsó betüjének meghatározása: (Lehet kettős betü is)
...
//                A név első két betüjének feldolgozása:
...
begin
  ...
  // A kettős betük lekezelése: CS, ZS
  ...
  // A kettős betük lekezelése: NY, GY, TY
