...
begin
  ...
  // --------------- természetes személy adatmezője  ---------------------------
  ...
  _oxl.worksheets[2].Cells[6,6] := 'FŐ TEVÉKENYSÉGE';
  _oxl.worksheets[2].Cells[6,7] := 'MEGBIZOTT NEVE';
  _oxl.worksheets[2].Cells[6,8] := 'KÉPVISELŐ NEVE';
