...
begin
  ...
  _oxl.Range['B6:G7'].Font.Italic:= True;
   ...
   // A fejléc két első oszlopa-első sora betüméret = 12;

  _oxl.Range['B6:E6'].Font.Size := 12;

  // A fejléc első 2 oszlopa-második sora betüméret: 10 (száma,megnevezése)
  ...
  _oxl.Cells[6,6] := 'SZÁZALÉKOS NŐVEKEDÉS';
  ...
  // Pénztárosok helyezéseinek főcimsora:
  ...
  // fEJLÉC 2. sora első 4 oszlop (betüméret= 10):
  ...
  _oxl.Cells[_focim2sor+2,6] := 'SZÁZALÉKOS NŐVEKEDÉS';
