...
begin
  ...
  MainMemo.Lines.Add('Jogi személyek adatEllenőrzése');
...
begin
  ...
  while _betu<=90 do
    begin
      _nevtabla := chr(_betu)+'NEV';
      MainMemo.Lines.add(_nevtabla+' ellenőrzése');
...
begin
  ...
  case _hkod of
     ...
     4: _errmess := 'Születési idő hibás ('+_szulido+')';
...
begin
  ...
  while _betu<=90 do
    begin
      _nevtabla := chr(_betu) + 'NEV';
      Procmemo.Lines.add(_nevtabla+' ellenőrzése ...');
...
begin
  ...
  case _hkod of
    ...
    4: _errmess := 'Hiányzik a főtevékenység';
    5: _errmess := 'Hiányzik a megbizott neve';
    6: _errmess := 'Hiányzik a képviselő neve';
    7: _errmess := 'Hiányzik a megbizott beosztása';
    8: _errmess := 'Hiányzik a képviselő beosztása';
...
begin
 ...
 _tHibas[1] := 'Ügyfélnév javítása';
  ...
  _tHibas[4] := 'Születési idő javítása';
...
begin
  ...
  if not Mugytabla.exists then
    begin
      Mugydbase.close;
      Showmessage('Nincsenek adatok a kért személyről');
      exit;
    end;
